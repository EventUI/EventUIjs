...
@returns {Boolean}*/
EVUITest2.Constants.Fn_Predicate = function (assertionValue) { };

/**A predicate function that takes a ValueEqualityContext and determines if the values are equal or not.
@param {EVUITest2.ValueEqualityContext} equalityContext The comparison context of the values.
@returns {Boolean}*/
EVUITest2.Constants.Fn_EqualityComparer = function (equalityContext) { };
...
EVUITest2.Settings.outputWriter = null;
(function ()
{
    var writer = null;

    Object.defineProperty(EVUITest2.Settings, "outputWriter", {
        get: function ()
        {
            if (writer == null) writer = new EVUITest2.OutputWriter();
            return writer;
        },
        set: function (value)
        {
...
EVUITest2.TestHostController = function ()
{
    ...
    {
        if (typeof EVUITest2.Settings.outputWriter?.writeTestOuput !== "function")
        {
        ...
        else
        {
            ...
            try
            {
                EVUITest2.Settings.outputWriter.writeTestOuput(result);
            }
            catch (ex)
            {
                writeOutput(ex);
    ...
    {
        if (typeof EVUITest2.Settings.outputWriter?.writeOutput !== "function")
        {
        ...
        else
        {
            ...
            try
            {
                EVUITest2.Settings.outputWriter.writeTestOuput(...args);
            }
            catch (ex)
            {
                console.log(ex);
...
@param {EVUITest2.AssertionSettings} settings Optional arguments to feed into the Assertion.
@class*/
EVUITest2.Assertion = function (value, settings)
{
    ...
    @type {EVUITest2.AssertionSettings}*/
    var _settings = null;

    /**Object. The latest comparison made by this Assertion.
    @type {EVUITest2.ValueCompareResult|EVUITest2.ValueContainmentResult|EVUITest2.ValuePredicateResult}*/
    ...
    @param {EVUITest2.AssertionSettings|EVUITest2.ValueCompareOptions|EVUITest2.AssertionLogOptions} assertionSettings The settings to give the assertion.
    @returns {EVUITest2.Assertion} */
    ...
    @returns {EVUITest2.AssertionSettings}*/
    ...
    @returns {EVUITest2.ValueCompareResult|EVUITest2.ValueContainmentResult|EVUITest2.ValuePredicateResult}*/
    ...
    @param {EVUITest2.AssertionSettings|EVUITest2.ValueCompareOptions|EVUITest2.AssertionLogOptions} compareOptions Optional. The options for the operation - can be a YOLO of any combination of ValueCompareOptions, AssertionLogOptions, or AssertionSettings.
    @returns {EVUITest2.Assertion}*/
    this.equals = function (b, compareOptions)
    {
        var defaultSettings = {};
        defaultSettings.affirmitiveCheck = true;
        defaultSettings.compareType = EVUITest2.ValueCompareType.Equality;
    ...
    @param {EVUITest2.Constants.Fn_Predicate} predicate The function to feed Assertion's value into.
    @param {EVUITest2.AssertionSettings|EVUITest2.ValueCompareOptions|EVUITest2.AssertionLogOptions} compareOptions Optional. The options for the operation - can be a YOLO of any combination of ValueCompareOptions, AssertionLogOptions, or AssertionSettings.
    @returns {EVUITest2.Assertion}*/
    this.isTrue = function (predicate, compareOptions)
    {
        var defaultSettings = {};
        defaultSettings.affirmitiveCheck = true;
        defaultSettings.compareType = EVUITest2.ValueCompareType.Predicate;
    ...
    this.contains = function (value, compareOptions)
    {
        var defaultSettings = {};
        defaultSettings.affirmitiveCheck = true;
        defaultSettings.compareType = EVUITest2.ValueCompareType.Containment;
    ...
    this.isEquivalentTo = function (b, compareOptions)
    {
        var defaultSettings = {};
        defaultSettings.affirmitiveCheck = true;
        defaultSettings.compareType = EVUITest2.ValueCompareType.Equivalency;
        defaultSettings.shortCircuit = true;
    ...
    @param {EVUITest2.AssertionSettings|EVUITest2.ValueCompareOptions|EVUITest2.AssertionLogOptions} compareOptions The options for the operation - can be a YOLO of any combination of ValueCompareOptions, AssertionLogOptions, or AssertionSettings.
    @returns {EVUITest2.Assertion}*/
    ...
    @param {EVUITest2.ValueCompareOptions} userOptions The comparison options provided by the user.
    @param {EVUITest2.ValueCompareOptions} defaultSettings The required settings to make sure the operation does the right thing.
    @returns {Error}*/
    ...
    @param {EVUITest2.AssertionSettings} settings The object derived from user's AssertionSettings.
    @returns {EVUITest2.ValueComparer} */
    var getComparer = function (settings)
    {
        if (settings != null && settings.comparer instanceof EVUITest2.ValueComparer === true)
        {
            return settings.comparer;
        }
        else if (_settings.comparer instanceof EVUITest2.ValueComparer === true)
        {
            return _settings.comparer;
        }
        else
        {
            return EVUITest2.ValueComparer.Default;
        }
    };

    /**Gets an AssertionSettings object based on ambiguous user input.
    @param {EVUITest2.AssertionSettings|EVUITest2.ValueCompareOptions|EVUITest2.AssertionLogOptions} userSettings The YOLO graph provided by the user.
    @returns {EVUITest2.AssertionSettings} */
    var getSettingsAmbiguously = function (userSettings)
    {
        if (userSettings == null || typeof userSettings !== "object") return;

        var comparer = EVUITest2.ValueComparer.Default;
        var compareOptions = {};
        var logOptions = {};
        var assertionSettings = {};

        if (userSettings instanceof EVUITest2.ValueEqualityComparer === true)
        {
            comparer = userSettings;
        }
        else
        {
            if (userSettings.comparer instanceof EVUITest2.ValueEqualityComparer === true) comparer = userSettings.comparer;
        }
        ...
        if (typeof assertionSettings.logOnSuccess !== "boolean") assertionSettings.logOnSuccess = EVUITest2.Settings.logOnSuccess;
        if (typeof assertionSettings.throwOnFailure !== "boolean") assertionSettings.throwOnFailure = EVUITest2.Settings.throwOnFailure;
    ...
    @param {EVUITest2.ValueCompareOptions} userOptions The options object made from the user's options parameter.
    @param {EVUITest2.ValueCompareOptions} requiredSettings The settings for the operation that are mandatory so that the comparer behaves correctly.
    @returns {EVUITest2.ValueCompareOptions} */
    ...
    @param {EVUITest2.AssertionSettings} settings The user's AssertionSettings YOLO graph.
    @returns {EVUITest2.AssertionSettings}*/
    var ensureSettings = function (settings)
    {
        if (settings == null || typeof settings !== "object")
        {
            settings = new EVUITest2.AssertionSettings();
            settings.comparer = EVUITest2.ValueComparer.Default;
            settings.compareOptions = {};
            settings.logOptions = {};
        }
        else
        {
            if (settings.comparer instanceof EVUITest2.ValueComparer === false) settings.comparer = EVUITest2.ValueComparer.Default;
            ...
            if (typeof settings.logOnSuccess !== "boolean") settings.logOnSuccess = EVUITest2.Settings.logOnSuccess;
            if (typeof settings.throwOnFailure == "boolean") settings.throwOnFailure = EVUITest2.Settings.throwOnFailure;
        }
    ...
    var writeOutput = function (output)
    {
        try
        {
            if (EVUITest2.Settings.outputWriter == null)
            {
                console.log(output);
            }
            else
            {
                EVUITest2.Settings.outputWriter.writeOuput(output);
            }
        }
        catch (ex)
        {
    ...
    @param {EVUITest2.ValueCompareResult|EVUITest2.ValueContainmentResult|EVUITest2.ValuePredicateResult} comparisonResult
    @returns {String} */
    var getComparisonMessage = function (comparisonResult)
    {
        ...
        if (comparisonResult.resultType === EVUITest2.ValueResultType.Compare)
        {
            return getValueCompareMessage(comparisonResult);
        }
        else if (comparisonResult.resultType === EVUITest2.ValueResultType.Containment)
        {
            return getContainmentCompareMessage(comparisonResult);
        }
        else if (comparisonResult.resultType === EVUITest2.ValueResultType.Predicate)
        {
    ...
    @param {EVUITest2.ValueCompareResult} valueComparison The comparison to make the message for.
    @returns {String} */
    ...
    @param {EVUITest2.AssertionLogOptions} logOptions The options for how the value should be logged or displayed in an error message.
    @returns {String} */
    ...
    @param {EVUITest2.ValueCompareResult|EVUITest2.ValueContainmentResult|EVUITest2.ValuePredicateResult} comparisonResult The comparison to get the operation name for.
    @returns {String} */
    var getOperationStringForm = function (comparisonResult)
    {
        if (comparisonResult.options.compareType === EVUITest2.ValueCompareType.Equality)
        {
        ...
        else if (comparisonResult.options.compareType === EVUITest2.ValueCompareType.Equivalency)
        {
            if (comparisonResult.valuesEqual === false)
            {
        ...
        else if (comparisonResult.options.compareType === EVUITest2.ValueCompareType.Roughly)
        {
            if (comparisonResult.valuesEqual === false)
            {
        ...
        else if (comparisonResult.options.compareType === EVUITest2.ValueCompareType.Containment)
        {
        ...
        else if (comparisonResult.options.compareType === EVUITest2.ValueCompareType.Predicate)
        {
    ...
    @param {EVUITest2.ValueCompareResult} valueComparison The comparison to get the first failed comparison from.
    @returns {EVUITest2.ValueCompareResult} */
    ...
    @param {EVUITest2.ValueContainmentResult} containmentComparison The containment comparison result.
    @returns {String} */
    ...
    @param {EVUITest2.ValuePredicateResult} predicateComparison The predicate comparison result.
    @returns {String}*/
...
@class*/
EVUITest2.ValueComparer = function ()
{
    //self reference for closures
    var _self = this;

    /**
    @type {EVUITest2.ValueEqualityComparer[]}*/
    var _comparers = [];

    /**Adds a ValueEqualityComparer to this ValueComparer's collection of ValueEqualityComparers.
    @param {EVUITest2.ValueEqualityComparer} comparer The comparer to add.*/
    ...
    @param {EVUITest2.ValueCompareOptions} options The settings that control what type of "comparison" is done and the rules for determining the equality of values.
    @returns {EVUITest2.ValueCompareResult|EVUITest2.ValueContainmentResult|EVUITest2.ValuePredicateResult}*/
    this.compare = function (a, b, options)
    {
        ...
        if (options.compareType === EVUITest2.ValueCompareType.Equality ||
            options.compareType === EVUITest2.ValueCompareType.Equivalency ||
            options.compareType === EVUITest2.ValueCompareType.Roughly)
        {
            return compareValues(a, b, context);
        }
        else if (options.compareType === EVUITest2.ValueCompareType.Containment)
        {
            return containmentCompare(a, b, context);
        }
        else if (options.compareType === EVUITest2.ValueCompareType.Predicate)
        {
    ...
    @param {EVUITest2.ValueCompareOptions} options The ValueCompareOptions that is being used in the comparison.
    @returns {EVUITest2.ValueEqualityComparer[]} */
    ...
    @param {EVUITest2.ValueCompareResult} parentComparison The comparison that is the direct parent to this one.
    @returns {EVUITest2.ValueCompareResult}*/
    var compareValues = function (a, b, context, key, parentComparison)
    {
        var comparison = new EVUITest2.ValueCompareResult(parentComparison);
        comparison.a = a;
        comparison.b = b;
    ...
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {EVUITest2.ValuePredicateResult}*/
    var predicateCompare = function (value, predicate, context)
    {
        ...
        var predicateResult = new EVUITest2.ValuePredicateResult();
    ...
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {EVUITest2.ValueContainmentResult}*/
    var containmentCompare = function (array, value, context)
    {
        var containmentComparison = new EVUITest2.ValueContainmentResult();
    ...
    @param {EVUITest2.ValueCompareResult} comparison The comparison being fed into a ValueEqualityComparer.
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {EVUITest2.ValueEqualityContext}*/
    var buildEqualityContext = function (comparison, context)
    {
        var currentContext = new EVUITest2.ValueEqualityContext();
    ...
    @param {EVUITest2.ValueEqualityContext} equalityContext The metadata about the equality comparison.
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {EVUITest2.ValueEqualityComparer[]}*/
    var getEqualityComparers = function (equalityContext, context)
    {
        ...
        for (var x = 0; x < numTotal; x++)
        {
            ...
            var flags = typeof curComparer.filterFlags !== "number" ? EVUITest2.EqualityFilterFlags.All : curComparer.filterFlags;

            if (flags & EVUITest2.EqualityFilterFlags.TypeOf === EVUITest2.EqualityFilterFlags.TypeOf)
            {
            ...
            if (flags & EVUITest2.EqualityFilterFlags.Prototype === EVUITest2.EqualityFilterFlags.Prototype)
            {
            ...
            if (flags & EVUITest2.EqualityFilterFlags.Predicate === EVUITest2.EqualityFilterFlags.Predicate)
            {
    ...
    @param {EVUITest2.ValueCompareResult} comparison The comparison with the values to compare.
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {Boolean} */
    ...
    @param {EVUITest2.ValueCompareResult} comparison The comparison of objects.
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {Boolean}*/
    ...
    @param {EVUITest2.ValueCompareResult} comparison The comparison containing the two arrays.
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {Boolean}*/
    ...
    @param {EVUITest2.ValueCompareResult} comparison The comparison holding the arrays.
    @param {ComparisonContext} context The contextual information about the comparison.
    @returns {Boolean}*/
    ...
    @param {EVUITest2.ValueCompareResult} curComparison The current comparison.
    ...
    @param {EVUITest2.ValueCompareOptions} options The user's options object.
    @returns {EVUITest2.ValueCompareOptions}*/
    var ensureOptions = function (options)
    {
        ...
        {
            options = new EVUITest2.ValueCompareOptions();
        }
        ...
        if (typeof compareType === "string")
        {
            ...
            if (compareType !== EVUITest2.ValueCompareType.Containment
                && compareType !== EVUITest2.ValueCompareType.Equality
                && compareType !== EVUITest2.ValueCompareType.Equivalency
                && compareType !== EVUITest2.ValueCompareType.Predicate)
            {
                compareType = EVUITest2.ValueCompareType.Equality;
            }
        }
        ...
        if (compareType === EVUITest2.ValueCompareType.Equivalency)
        {
        ...
        else if (compareType === EVUITest2.ValueCompareType.Roughly)
        {
    ...
    var CompareStackItem = function ()
    {
        ...
        @type {EVUITest2.ValueCompareResult}*/
...
@type {EVUITest2.ValueComparer}*/
EVUITest2.ValueComparer.Default = null;

(function ()
{
    var comparer = null;

    Object.defineProperty(EVUITest2.ValueComparer, "Default", {
        get: function ()
        {
            if (comparer == null)
            {
                comparer = Object.freeze(new EVUITest2.ValueComparer());
                comparer.addEqualityComparer(EVUITest2.ValueEqualityComparer.DomNodeComparer);
            }
...
@class*/
EVUITest2.ValueCompareResult = function (parent)
{
    var _parent = parent;

    /**String. The value from the ValueResultType enum indicating what type of result object this is.
    @type {String}*/
    this.resultType = EVUITest2.ValueResultType.Compare;
...
@class*/
EVUITest2.ValueContainmentResult = function ()
{
    /**String. The value from the ValueResultType enum indicating what type of result object this is.
    @type {String}*/
    this.resultType = EVUITest2.ValueResultType.Containment;
...
@class*/
EVUITest2.ValuePredicateResult = function ()
{
    /**String. The value from the ValueResultType enum indicating what type of result object this is.
    @type {String}*/
    this.resultType = EVUITest2.ValueResultType.Predicate;

    /**Function. The predicate function being tested.
    @type {EVUITest2.Constants.Fn_Predicate}*/
...
@class*/
EVUITest2.ValueEqualityComparer = function ()
{
    ...
    @type {EVUITest2.Constants.Fn_EqualityComparer}*/
    this.predicateFilter = null;

    /**Number. The bit flags for which filters to apply.
    @type {Number}*/
    this.filterFlags = EVUITest2.EqualityFilterFlags.All;
...
@type {EVUITest2.ValueEqualityComparer}*/
EVUITest2.ValueEqualityComparer.DomNodeComparer = null;
...
(function ()
{
    ...
    var domCompare = new EVUITest2.ValueEqualityComparer();
    domCompare.prototypeFilter = Node;
    domCompare.name = "evui-dom-node";
    domCompare.typeOfFilter = "object";
    domCompare.filterFlags |= EVUITest2.EqualityFilterFlags.TypeOf | EVUITest2.EqualityFilterFlags.Prototype;
    ...
    Object.defineProperty(EVUITest2.ValueEqualityComparer, "DomNodeComparer", {
        get: function ()
        {
            return domCompare;
        },
...
@class*/
EVUITest2.ValueEqualityContext = function ()
{
...
@param {EVUITest2.AssertionSettings} settings Any non-default settings to apply to the assertion or its underlying comparison logic.
@returns {EVUITest2.Assertion}*/
$evui.assert = function (value, settings)
{
    return new EVUITest2.Assertion(value, settings);
};
