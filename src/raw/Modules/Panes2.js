...
/*#BEGINWRAP(EVUI.Modules.NewPanes|Pane)#*/
/*#REPLACE(EVUI.Modules.NewPanes|Pane)#*/
...
@module*/
EVUI.Modules.NewPanes = {};

/*#MODULEDEF(Pane|"1.0";|"Pane")#*/
/*#VERSIONCHECK(EVUI.Modules.NewPanes|Pane)#*/

EVUI.Modules.NewPanes.Constants = {};

/**Function for selecting a PaneEntry object. Return true to select the PaneEntry parameter as part of the result set.
@param {EVUI.Modules.NewPanes.Pane} pane The PaneEntry providing metadata about a Pane object.
@returns {Boolean}*/
...
EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback = function (success) { };

EVUI.Modules.NewPanes.Constants.CSS_Position = "evui-position";
EVUI.Modules.NewPanes.Constants.CSS_ClippedX = "evui-clipped-x";
EVUI.Modules.NewPanes.Constants.CSS_ClippedY = "evui-clipped-y";
EVUI.Modules.NewPanes.Constants.CSS_ScrollX = "evui-scroll-x";
EVUI.Modules.NewPanes.Constants.CSS_ScrollY = "evui-scroll-y"
EVUI.Modules.NewPanes.Constants.CSS_Flipped = "evui-flipped";
EVUI.Modules.NewPanes.Constants.CSS_Moved = "evui-moved";
EVUI.Modules.NewPanes.Constants.CSS_Resized = "evui-resized";
EVUI.Modules.NewPanes.Constants.CSS_Backdrop = "evui-backdrop";
EVUI.Modules.NewPanes.Constants.CSS_Transition_Show = "evui-transition-show";
EVUI.Modules.NewPanes.Constants.CSS_Transition_Hide = "evui-transition-hide";
EVUI.Modules.NewPanes.Constants.CSS_Transition_Adjust = "evui-transition-adjust";

EVUI.Modules.NewPanes.Constants.CascadeCloseGroup_DropdownDefault = "evui-dropdown-default";

/**String. The name of the ID attribute for the Pane, used to look up a definition of a Pane.
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_ID = "evui-pane-id";

/**String. The name of the attribute that signifies which element should receive initial focus when the Pane is displayed.
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_Focus = "evui-pane-focus";

/**String. The name of the attribute that signifies that a click event on the Element should close the Pane.
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_Close = "evui-pane-close";

/**String. The name of the attribute that signifies that a drag event on the Element should move the Pane.
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_Drag = "evui-pane-drag-handle";
...
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_SourceURL = "evui-pane-src";
...
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_PlaceholderID = "evui-pane-placeholder-id";
...
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_UnloadOnHide = "evui-pane-unload";
...
@type {String}*/
EVUI.Modules.NewPanes.Constants.Attribute_Context = "evui-pane-cxt";
...
EVUI.Modules.NewPanes.Constants.Event_OnUnload = "unload";
EVUI.Modules.NewPanes.Constants.Event_OnLoad = "load";

EVUI.Modules.NewPanes.Constants.Event_OnShown = "shown";
EVUI.Modules.NewPanes.Constants.Event_OnHidden = "hidden";
EVUI.Modules.NewPanes.Constants.Event_OnLoaded = "loaded";
EVUI.Modules.NewPanes.Constants.Event_OnUnloaded = "unloaded";

EVUI.Modules.NewPanes.Constants.Event_OnInitialize = "init";
EVUI.Modules.NewPanes.Constants.Event_OnPosition = "position";

EVUI.Modules.NewPanes.Constants.Job_Complete = "job.complete";
EVUI.Modules.NewPanes.Constants.Job_Preload = "job.preload";
EVUI.Modules.NewPanes.Constants.Job_Load = "job.load";
EVUI.Modules.NewPanes.Constants.Job_Initialize = "job.init";
EVUI.Modules.NewPanes.Constants.Job_Hide = "job.hide";
EVUI.Modules.NewPanes.Constants.Job_InitialPosition = "job.initialposition";
EVUI.Modules.NewPanes.Constants.Job_FinalPosition = "job.finalposition";
EVUI.Modules.NewPanes.Constants.Job_Unload = "job.unload";

EVUI.Modules.NewPanes.Constants.CssPrefix = "evui-pane";
EVUI.Modules.NewPanes.Constants.StepPrefix = "evui.pane";

/**The global Z-index reference for all objects that use the pane manager to determine their z-index.
@type {Number}*/
EVUI.Modules.NewPanes.Constants.GlobalZIndex = null;

(function()
{
    var globalZIndex = null;
    Object.defineProperty(EVUI.Modules.NewPanes.Constants, "GlobalZIndex",
    {
...
Object.freeze(EVUI.Modules.NewPanes.Constants);

EVUI.Modules.NewPanes.Dependencies =
{
...
(function ()
{
    ...
    Object.defineProperty(EVUI.Modules.NewPanes.Dependencies, "checked",
    {
...
Object.freeze(EVUI.Modules.NewPanes.Dependencies);

/**Class for managing an implementation of Pane objects.
@param {EVUI.Modules.NewPanes.PaneManagerServices} paneManagerServices Controllers for accessing other parts of the EventUI API.
@class*/
EVUI.Modules.NewPanes.PaneManager = function (paneManagerServices)
{
    if (EVUI.Modules.Core == null) throw Error("Dependency missing: EVUI.Modules.Core is required.");
    EVUI.Modules.Core.Utils.requireAll(EVUI.Modules.NewPanes.Dependencies);

    if (EVUI.Modules.NewPanes.Constants.GlobalZIndex == null)
    {
        var minZIndex = EVUI.Modules.Core.Settings.defaultMinimumZIndex;
        if (typeof minZIndex !== "number") minZIndex = 100;

        EVUI.Modules.NewPanes.Constants.GlobalZIndex = minZIndex;
    }
    ...
    var PaneLink = function ()
    {
        ...
        @type {Number}*/
        this.paneStateFlags = EVUI.Modules.NewPanes.PaneStateFlags.None;

        /**String. The current operation the pane is performing (loading, unloading, hiding, showing, etc).
        @type {String}*/
        this.paneAction = EVUI.Modules.NewPanes.PaneAction.None;
        ...
        @type {EVUI.Modules.NewPanes.PaneEventBinding[]}*/
        this.eventBindings = [];

        /**The PaneManager that owns this pane.
        @type {EVUI.Modules.NewPanes.PaneManager}*/
        this.manager = null;
        ...
        @type {EVUI.Modules.NewPanes.PanePosition}*/
    ...
    var InternalPaneEntry = function ()
    {
        ...
        @type {EVUI.Modules.NewPanes.PaneEntry}*/
    ...
    var CallbackStack = function ()
    {
        ...
        @type {String}*/
        this.action = EVUI.Modules.NewPanes.PaneAction.None;
    };
    ...
    var PaneOperationSession = function ()
    {
        ...
        @type {EVUI.Modules.NewPanes.PaneHideArgs}*/
        this.hideArgs = null;
        ...
        @type {EVUI.Modules.NewPanes.PaneArgsPackage}*/
        ...
        @returns {EVUI.Modules.NewPanes.PaneArgsPackage}*/
        this.makeArgsPackage = function (context)
        {
            var argsPackage = new EVUI.Modules.NewPanes.PaneArgsPackage(context);

            argsPackage.foreignArgs = this.foreignActionArgs;
            //if (argsPackage.foreignArgs == null && _settings.managerName !== EVUI.Modules.NewPanes.Constants.Default_ManagerName) EVUI.Modules.Core.Utils.wrapProperties(argsPackage, this, { sourcePath: "foreignActionArgs", targetPath: "foreignActionArgs" });
    ...
    var BackdropManager = function ()
    {
        ...
        @param {EVUI.Modules.NewPanes.PaneBackdropSettings} backdropSettings The settings for controlling the style of the backdrop and its transition effect.
        @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback A callback function that is fired once the show transition is complete.*/
        this.showBackdrop = function (objectCSSName, zIndex, backdropSettings, callback)
        {
            ...
            applyTransition(backdropSettings.backdropShowTransition, EVUI.Modules.NewPanes.Constants.CSS_Transition_Show, function (success)
            {
                callback(success);
            });
        };
        ...
        @param {EVUI.Modules.NewPanes.PaneBackdropSettings} backdropSettings The settings for how to hide the backdrop.
        @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback A callback that is fired once the hide transition is complete.*/
        this.hideBackdrop = function (objectCSSName, backdropSettings, callback)
        {
            ...
            applyTransition(backdropSettings.backdropHideTransition, EVUI.Modules.NewPanes.Constants.CSS_Transition_Hide, function (success)
            {
        ...
        @param {EVUI.Modules.NewPanes.PaneBackdropSettings} backdropSettings The backdrop settings containing the information to use to make the backdrop.*/
        var setBackdropShowCSS = function (backdropSettings, zIndex)
        {
            ...
            _backdropHelper.addClass([EVUI.Modules.NewPanes.Constants.CSS_Backdrop, _backdropObjectCssName]);
        ...
        var setBackdropHideCSS = function ()
        {
            ...
            _backdropDiv.classList.add(EVUI.Modules.NewPanes.Constants.CSS_Backdrop);

            var defaultSelector = getDefaultCssSelector(_backdropObjectCssName);

            //remove the rules that were specific to this backdrop and the general rules for the backdrop.
            _settings.stylesheetManager.removeRules(_backdropCSSSheetName, [defaultSelector, EVUI.Modules.NewPanes.Constants.CSS_Backdrop]);

            //re-add the rules in their new format.
            _settings.stylesheetManager.setRules(_backdropCSSSheetName, EVUI.Modules.NewPanes.Constants.CSS_Backdrop, defaultSettings);
        };

        /**Applies a transition effect to the backdrop to show or hide it.
        @param {EVUI.Modules.NewPanes.PaneTransition} transition The transition to apply.
        @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback A callback that is called once the transition is complete.*/
        ...
        {
            return "." + objectCSSName + "." + EVUI.Modules.NewPanes.Constants.CSS_Backdrop;
        };
    ...
    @param {EVUI.Modules.NewPanes.Pane} pane A YOLO object representing a Pane object. This object is copied onto a real Pane object is then discarded.
    @returns {EVUI.Modules.NewPanes.Pane}*/
    this.addPane = function (pane)
    {
        if (pane == null) throw Error("Pane cannot be null.");

        var creationResult = makeOrExtendPane(pane, true);
        if (creationResult.exists === true) throw Error("A Pane with an id of \"" + creationResult.pane.id + "\" already exists.");
    ...
    @param {EVUI.Modules.NewPanes.Pane|String} paneOrID
    @returns {Boolean}*/
    ...
    @param {EVUI.Modules.NewPanes.Constants.Fn_PaneSelector|String} paneIDOrSelector A selector function to select a PaneEntry object (or multiple PaneEntry objects) or the ID of the Pane to get the PaneEntry for.
    ...
    @returns {EVUI.Modules.NewPanes.Pane|EVUI.Modules.NewPanes.Pane[]} */
    ...
    this.showPane = function (paneOrID, paneShowArgs, callback)
    {
        ...
        {
            paneShowArgs = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneShowArgs(), paneShowArgs, ["type"]);

            if (paneShowArgs.showSettings != null)
            {
                if (paneShowArgs.showSettings instanceof EVUI.Modules.NewPanes.PaneShowSettings === false) paneShowArgs.showSettings = makeOrExtendShowSettings(paneShowArgs.showSettings);
            }
            else
            {
            ...
            {
                if (paneShowArgs.loadArgs.loadSettings instanceof EVUI.Modules.NewPanes.PaneLoadSettings === false) paneShowArgs.loadArgs.loadSettings = makeOrExtendLoadSettings(paneShowArgs.loadArgs.loadSettings);
            }
            else
            {
    ...
    @param {EVUI.Modules.NewPanes.Pane|String} paneOrID Either a YOLO Pane object to extend into the existing Pane, the real Pane reference, or the string ID of the Pane to show.
    @param {EVUI.Modules.NewPanes.PaneShowArgs} paneShowArgs Optional. The arguments for showing the Pane. If omitted, the Pane's existing show/load settings are used instead.
    ...
    this.hidePane = function (paneOrID, paneHideArgs, callback)
    {
        ...
        {
            paneHideArgs = new EVUI.Modules.NewPanes.PaneHideArgs();
            paneHideArgs.unloadArgs = new EVUI.Modules.NewPanes.PaneUnloadArgs();
        }
    ...
    @param {EVUI.Modules.NewPanes.Pane|String} paneOrID Either a YOLO Pane object to extend into the existing Pane, the real Pane reference, or the string ID of the Pane to hide.
    @param {EVUI.Modules.NewPanes.PaneHideArgs} paneHideArgs Optional. The arguments for hiding a Pane. If omitted, the Pane's existing hide/unload settings are used instead.
    @returns {Promise<Boolean>}*/
    ...
    @param {EVUI.Modules.NewPanes.PaneHideArgs} paneHideArgs Optional. The arguments for hiding a Pane. If omitted, the Pane's existing hide/unload settings are used instead.
    @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback The callback that is called once all the Pane's hide operations have completed.*/
    ...
    @param {EVUI.Modules.NewPanes.Pane|String} paneOrID Either a YOLO Pane object to extend into the existing Pane, the real Pane reference, or the string ID of the Pane to load.
    @param {EVUI.Modules.NewPanes.PaneLoadArgs} paneLoadArgs Optional. A YOLO object representing arguments for loading a Pane.
    @returns {Promise<Boolean>}*/
    ...
    this.unloadPane = function (paneOrID, paneUnloadArgs, callback)
    {
        ...
        {
            paneUnloadArgs = new EVUI.Modules.NewPanes.PaneUnloadArgs();
        }
    ...
    @param {EVUI.Modules.NewPanes.Pane|String} paneOrID Either a YOLO Pane object to extend into the existing Pane, the real Pane reference, or the string ID of the Pane to unload.
    @param {EVUI.Modules.NewPanes.PaneUnloadArgs} paneUnloadArgs Optional. A YOLO object representing arguments for unloading a Pane. If omitted the Pane's existing unload settings are used instead.
    @returns {Promise<Boolean>}*/
    ...
    @param {EVUI.Modules.NewPanes.PaneEventArgs} paneEventArgs The event arguments for the Pane operation. The currentActionArgs property will be an instance of PaneLoadArgs.*/
    ...
    @param {EVUI.Modules.NewPanes.PaneEventArgs} paneEventArgs The event arguments for the Pane operation. The currentActionArgs property will be an instance of PaneShowArgs.*/
    ...
    @param {EVUI.Modules.NewPanes.PaneEventArgs} paneEventArgs The event arguments for the Pane operation. The currentActionArgs property will be an instance of PaneHideArgs.*/
    ...
    @param {EVUI.Modules.NewPanes.PaneEventArgs} paneEventArgs The event arguments for the Pane operation. The currentActionArgs property will be an instance of PaneUnloadArgs.*/
    ...
    @param {String|EVUI.Modules.NewPanes.Pane} paneOrID The string ID or Pane object to get.
    ...
    {
        if (paneOrID == null || (typeof paneOrID !== "string" && typeof paneOrID !== "object")) throw Error("Invalid input: Pane or string id expected.");
        ...
        if (typeof paneID !== "string") throw Error("Invalid input: Pane missing id.")

        var paneEntry = getInternalPaneEntry(paneID);
        if (paneEntry == null)
        {
            if (typeof paneOrID === "string" || addIfMissing !== true) throw Error("No Pane with an id of \"" + paneID + "\" exists.");

            var addResult = _self.addPane(paneOrID);
            if (addResult == null) throw Error("Failed to add Pane with an id of \"" + paneOrID + "\".");
    ...
    {
        var urlAttributeName = getAttributeName(EVUI.Modules.NewPanes.Constants.Attribute_SourceURL);
        var placeholderAttributeName = getAttributeName(EVUI.Modules.NewPanes.Constants.Attribute_PlaceholderID);
        var selectorAttributeName = getAttributeName(EVUI.Modules.NewPanes.Constants.Attribute_Selector);
        var idAttr = getAttributeName(EVUI.Modules.NewPanes.Constants.Attribute_ID);
    ...
    var getAttributeName = function (attribute)
    {
        ...
        //if (lowerName.startsWith(EVUI.Modules.NewPanes.Constants.Default_AttributePrefix) === true)
        //{
        //    return _settings.attributePrefix + attribute.substring(EVUI.Modules.NewPanes.Constants.Default_AttributePrefix.length);
        //}
    ...
    var canSetElement = function (paneElementSetter)
    {
        ...
        if (EVUI.Modules.Core.Utils.hasFlag(entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded)) throw Error("Failed to set element for pane \"" + paneElementSetter.paneID + "\": Pane has been loaded. Unload it before attempting to set element.");
    ...
    var getClassName = function (paneID)
    {
        ...
        var className = EVUI.Modules.NewPanes.Constants.CssPrefix + "-" + paneID;
    ...
    @param {EVUI.Modules.NewPanes.Pane} yoloPane The YOLO object passed in by the user into one of the entry point functions.
    ...
    var makeOrExtendPane = function (yoloPane, addIfMissing)
    {
        ...
        else
        {
            ...
            paneToExtend = new EVUI.Modules.NewPanes.Pane(id, options);

            link.pane = paneToExtend;


            var entry = new EVUI.Modules.NewPanes.PaneEntry(link);
            ...
            defaultPane = getDefaultPane(yoloPane.template);
        }
        ...
        paneToExtend.resizeMoveSettings = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneResizeMoveSettings(), paneToExtend.resizeMoveSettings, safeCopy.resizeMoveSettings);
        paneToExtend.autoCloseSettings = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneAutoCloseSettings(), paneToExtend.autoCloseSettings, safeCopy.autoCloseSettings);
        paneToExtend.autoCloseSettings.autoCloseKeys = paneToExtend.autoCloseSettings.autoCloseKeys.slice();
        paneToExtend.reclacSettings = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneRecalcSettings(), paneToExtend.reclacSettings, safeCopy.reclacSettings);
    ...
    var getDefaultPane = function (templateType)
    {
        ...
        {            
            return {
                ...
                clipSettings:
                {
                    clipMode: EVUI.Modules.NewPanes.PaneClipMode.Shift,
        ...
        else if (templateType === EVUI.Modules.NewPanes.PaneTemplateType.Dropdown)
        {
            return {
                ...
                showSettings:
                {
                    ...
                    clipSettings:
                    {
                        mode: EVUI.Modules.NewPanes.PaneClipMode.Shift,
                        clipBounds: document.documentElement
                    }
                }
            };
        ...
        else if (templateType === EVUI.Modules.NewPanes.PaneTemplateType.Modal)
        {
            return {
                ...
                clipSettings:
                {
                    clipMode: EVUI.Modules.NewPanes.PaneClipMode.Clip,
                    clipBounds: document.documentElement
                }
            };
        }
     ...
     */
    var cascadeClose = function (opSession)
    {
   ...
   @param {EVUI.Modules.NewPanes.PaneAutoTriggerContext} autoCloseArgs The auto-close arguments from the Pane's auto-close handlers.
   @returns {Boolean} */
    var shouldAutoCloseDropdown = function (autoCloseArgs)
    {
        if (autoCloseArgs == null) return true;
        if (autoCloseArgs.triggerType === EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.Click)
        {
            return shouldAutoCloseOnClick(autoCloseArgs);
        }
        else if (autoCloseArgs.triggerType === EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.KeyDown)
        {
    ...
    @param {EVUI.Modules.NewPanes.PaneAutoTriggerContext} autoCloseArgs The auto-close arguments generated by the Pane's auto-close handlers.
    @returns {Boolean}*/
    var shouldAutoCloseDropdownOnClick = function (autoCloseArgs)
    {
    ...
    @param {EVUI.Modules.NewPanes.PaneAutoTriggerContext} autoCloseArgs The auto-close args generated by the handler.
    @returns {Boolean} */
    var shouldAutoCloseDropdownOnKeydown = function (autoCloseArgs)
    {
    ...
    @param {EVUI.Modules.NewPanes.PaneShowSettings} showSettings A show settings object made by a user.
    @returns {EVUI.Modules.NewPanes.PaneShowSettings}*/
    var makeOrExtendShowSettings = function (showSettings, yoloSettings)
    {
        if (showSettings == null) return new EVUI.Modules.NewPanes.PaneShowSettings();

        var copy = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneShowSettings(), showSettings, yoloSettings);
        if (yoloSettings == null) yoloSettings = {};

        if (copy.anchors != null) copy.anchors = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneAnchors(), showSettings.anchors, yoloSettings.anchors);
        if (copy.absolutePosition != null) copy.absolutePosition = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneAbsolutePosition(), showSettings.absolutePosition, yoloSettings.absolutePosition);
        if (copy.documentFlow != null) copy.documentFlow = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneDocumentFlow(), showSettings.documentFlow, yoloSettings.documentFlow);
        if (copy.hideTransition != null) copy.hideTransition = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneTransition(), showSettings.hideTransition, yoloSettings.hideTransition);
        if (copy.showTransition != null) copy.showTransition = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneTransition(), showSettings.showTransition, yoloSettings.showTransition);
        if (copy.relativePosition != null) copy.relativePosition = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneRelativePosition(), showSettings.relativePosition, yoloSettings.relativePosition);
        if (copy.clipSettings != null) copy.clipSettings = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneClipSettings(), showSettings.clipSettings, yoloSettings.clipSettings);
        if (copy.backdropSettings != null) copy.backdropSettings = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneBackdropSettings(), showSettings.backdropSettings, yoloSettings.backdropSettings);

        return copy;
    };

    /**Makes or extends a PaneLoadSettings object.
    @param {EVUI.Modules.NewPanes.PaneLoadSettings} loadSettings A PaneLoadSettings object made by a user.
    @returns {EVUI.Modules.NewPanes.PaneShowSettings} */
    var makeOrExtendLoadSettings = function (loadSettings, yoloLoadSettings)
    {
        if (loadSettings == null) return new EVUI.Modules.NewPanes.PaneLoadSettings();

        var copy = EVUI.Modules.Core.Utils.makeOrExtendObject(new EVUI.Modules.NewPanes.PaneLoadSettings(), loadSettings, yoloLoadSettings);
        if (yoloLoadSettings == null) yoloLoadSettings = {};

        if (loadSettings.httpLoadArgs != null || yoloLoadSettings.httpLoadArgs != null)
        {
            EVUI.Modules.Core.Utils.require("Http", EVUI.Modules.NewPanes.Dependencies["Http"].version, "Cannot use httpLoadArgs.");
        ...
        {
            EVUI.Modules.Core.Utils.require("HtmlLoader", EVUI.Modules.NewPanes.Dependencies["HtmlLoader"].version, "Cannot use placeholderLoadArgs.");
    ...
    @param {EVUI.Modules.NewPanes.PaneShowSettings} showSettings The show settings to clone.
    @returns {EVUI.Modules.NewPanes.PaneShowSettings} */
    var cloneShowSettings = function (showSettings)
    {
        var copy = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneShowSettings(), showSettings);

        if (showSettings.absolutePosition != null) copy.absolutePosition = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneAbsolutePosition(), showSettings.absolutePosition);
        if (showSettings.anchors != null) copy.anchors = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneAnchors(), showSettings.anchors);
        if (showSettings.documentFlow != null) copy.documentFlow = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneDocumentFlow(), showSettings.documentFlow);
        if (showSettings.hideTransition != null) copy.hideTransition = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneTransition(), showSettings.hideTransition);
        if (showSettings.showTransition != null) copy.showTransition = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneTransition(), showSettings.showTransition);
        if (showSettings.relativePosition != null) copy.relativePosition = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneRelativePosition(), showSettings.relativePosition);
        if (showSettings.clipSettings != null) copy.clipSettings = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneClipSettings(), showSettings.clipSettings);
        if (showSettings.backdropSettings != null) copy.backdropSettings = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneBackdropSettings(), showSettings.backdropSettings);

        return copy;
    };

    /**Makes a clone of the Pane's PaneLoadSettings.
    @param {EVUI.Modules.NewPanes.PaneLoadSettings} loadSettings The load settings to clone.
    @returns {EVUI.Modules.NewPanes.PaneLoadSettings} */
    var cloneLoadSettings = function (loadSettings)
    {
        var copy = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PaneLoadSettings(), loadSettings);

        if (loadSettings.httpLoadArgs != null) 
        {
            EVUI.Modules.Core.Utils.require("Http", EVUI.Modules.NewPanes.Dependencies["HtmlLoader"].version, "Cannot use httpLoadArgs.");
            copy.httpLoadArgs = cloneHttpArgs(loadSettings.httpLoadArgs);
        }

        if (loadSettings.placeholderLoadArgs != null)
        {
            EVUI.Modules.Core.Utils.require("HtmlLoaderController", EVUI.Modules.NewPanes.Dependencies["HtmlLoader"].version, "Cannot use placeholderLoadArgs.");
    ...
    /** Gets a PaneEntry object based on its ID or a selector function.
    @param {EVUI.Modules.NewPanes.Constants.Fn_PaneEntrySelector|String} paneIDOrSelector A selector function to select a PaneEntry object (or multiple PaneEntry objects) or the ID of the Pane to get the PaneEntry for.
    @param {Boolean} getAllMatches If a selector function is provided, all the PaneEntries that satisfy the selector are included. Otherwise a single PaneEntry object is returned. False by default.
    @returns {EVUI.Modules.NewPanes.PaneEntry|EVUI.Modules.NewPanes.PaneEntry[]} */
    ...
    var continueOperation = function (eventStream, actionSequence, opSession)
    {
        ...
        var completeStep = opSession.entry.link.eventStream.getStep(EVUI.Modules.NewPanes.Constants.Job_Complete);
        ...
        var realCompleteStep = eventStream.getStep(EVUI.Modules.NewPanes.Constants.Job_Complete);
    ...
    var configureEventStream = function (eventStream, opSession)
    {
        ...
        eventStream.processInjectedEventArgs = function (eventStreamArgs)
        {
            ...
            var paneArgs = new EVUI.Modules.NewPanes.PaneEventArgs(opSession.entry, curArgs);
    ...
    var addLoadSteps = function (eventStream, opSession)
    {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_Preload,
            key: EVUI.Modules.NewPanes.Constants.Job_Preload,
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnLoad,
            key: EVUI.Modules.NewPanes.Constants.Event_OnLoad,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === true) return;
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_Load,
            key: EVUI.Modules.NewPanes.Constants.Job_Load,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (jobArgs)
            {
                if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === true && opSession.loadArgs.reload === false) return jobArgs.resolve();
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnLoaded,
            key: EVUI.Modules.NewPanes.Constants.Event_OnLoaded,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
    ...
    {
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnInitialize,
            key: EVUI.Modules.NewPanes.Constants.Event_OnInitialize,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                opSession.currentAction = EVUI.Modules.NewPanes.PaneAction.Show;

                if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Initialized) === true) return;
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_Initialize,
            key: EVUI.Modules.NewPanes.Constants.Job_Initialize,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (jobArgs)
            {
                opSession.entry.link.paneStateFlags |= EVUI.Modules.NewPanes.PaneStateFlags.Initialized;
                jobArgs.resolve();
            }
        });
    };
    ...
    {
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnShow,
            key: EVUI.Modules.NewPanes.Constants.Event_OnShow,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                opSession.currentAction = EVUI.Modules.NewPanes.PaneAction.Show;
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnShown,
            key: EVUI.Modules.NewPanes.Constants.Event_OnShown,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
    ...
    var addHideSteps = function (eventStream, opSession)
    {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnHide,
            key: EVUI.Modules.NewPanes.Constants.Event_OnHide,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                opSession.currentAction = EVUI.Modules.NewPanes.PaneAction.Hide;
                if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Visible) === false)
                {
                    skip = true;
                    return;
                }
        ...
        eventStream.addStep({
            ...
            handler: function (eventArgs)
            {
                if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Visible) === false) return;
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_Hide,
            key: EVUI.Modules.NewPanes.Constants.Job_Hide,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (jobArgs)
            {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnHidden,
            key: EVUI.Modules.NewPanes.Constants.Event_OnHidden,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                if (skip === true) return;
    ...
    var addPositionSteps = function (eventStream, opSession)
    {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_InitialPosition,
            key: EVUI.Modules.NewPanes.Constants.Job_InitialPosition,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (jobArgs)
            {
                opSession.action = EVUI.Modules.NewPanes.PaneAction.Show;
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnPosition,
            key: EVUI.Modules.NewPanes.Constants.Event_OnPosition,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_FinalPosition,
            key: EVUI.Modules.NewPanes.Constants.Job_FinalPosition,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (jobArgs)
            {
    ...
    var addOnCompleteStep = function (eventStream, opSession)
    {
        eventStream.addStep({
            ...
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_Complete,
            key: EVUI.Modules.NewPanes.Constants.Job_Complete,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (args)
            {
                var success = true;
                if (opSession.action === EVUI.Modules.NewPanes.PaneAction.Hide && EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Visible) === true) success = false;
                if (opSession.action === EVUI.Modules.NewPanes.PaneAction.Load && EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === false) success = false;
                if (opSession.action === EVUI.Modules.NewPanes.PaneAction.Show && EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Visible) === false) success = false;
                if (opSession.action === EVUI.Modules.NewPanes.PaneAction.Unload && EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === true) success = false;
                ...
                callCallbackStack(opSession.entry.link, opSession.action, success, function ()
                {
                    ...
                    opSession.entry.link.paneAction = EVUI.Modules.NewPanes.PaneAction.None;
    ...
    var addUnloadSteps = function (eventStream, opSession)
    {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnUnload,
            key: EVUI.Modules.NewPanes.Constants.Event_OnUnload,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                var priorAction = opSession.action;
                opSession.currentAction = EVUI.Modules.NewPanes.PaneAction.Unload;
                if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === false)
                {
                    skip = true;
                    return;
                }
        ...
        eventStream.addStep({
            ...
            handler: function (eventArgs)
            {
                if (skip === true || EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === false) return;
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Job_Unload,
            key: EVUI.Modules.NewPanes.Constants.Job_Unload,
            type: EVUI.Modules.EventStream.EventStreamStepType.Job,
            handler: function (jobArgs)
            {
        ...
        eventStream.addStep({
            name: EVUI.Modules.NewPanes.Constants.StepPrefix + "." + EVUI.Modules.NewPanes.Constants.Event_OnUnloaded,
            key: EVUI.Modules.NewPanes.Constants.Event_OnUnloaded,
            type: EVUI.Modules.EventStream.EventStreamStepType.Event,
            handler: function (eventArgs)
            {
                if (skip === true) return;
    ...
    var validateActionSequence = function (actionSequence, opSession)
    {
        ...
        if (opAction === EVUI.Modules.NewPanes.PaneAction.Load)
        {
            ...
            {
                if (currentAction === EVUI.Modules.NewPanes.PaneAction.Show)
                {
                    return [ActionSequence.Continue];
                }
                else if (currentAction === EVUI.Modules.NewPanes.PaneAction.Load)
                {
                    return [ActionSequence.Queue];
                }
                else if (currentAction === EVUI.Modules.NewPanes.PaneAction.Hide
                    || currentAction === EVUI.Modules.NewPanes.PaneAction.Unload
                    || currentAction === EVUI.Modules.NewPanes.PaneAction.None)
                {
                    return actionSequence;
                }
                else
        ...
        else if (opAction === EVUI.Modules.NewPanes.PaneAction.Show)
        {
            if (currentAction === EVUI.Modules.NewPanes.PaneAction.Load)
            {
                return actionSequence;
            }
    ...
    var getShowSequence = function (opSession)
    {
        ...
        if (shouldCancel === false && (opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Hide || opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Unload)) //if we're doing the opposite of show, stop the operation
        {
            sequence.push(ActionSequence.CancelCurrent);
        }

        if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Initialized) === false || opSession.showArgs.reInitialize === true) //whether or not the init function has been called - only called on the first show after it has been loaded. 
        {
    ...
    var getLoadSequence = function (opSession)
    {
        ...
        {
            if (opSession.entry.link.paneAction !== EVUI.Modules.NewPanes.PaneAction.None && opSession.entry.link.paneAction !== EVUI.Modules.NewPanes.PaneAction.Load) //if we were doing anything (other than another load operation), we need to cancel it  
            {
                sequence.push(ActionSequence.CancelCurrent);
            }

            if (opSession.entry.link.paneAction !== EVUI.Modules.NewPanes.PaneAction.Load) //if we're not doing a load operation, add the load step
            {
                //add the load step
                sequence.push(ActionSequence.Load);
            }
    ...
    var getHideSequence = function (opSession)
    {
        ...
        if (opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Load || opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Show || opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Unload) //if it's being loaded or shown (which also loads it), cancel that operation
        {
            sequence.push(ActionSequence.CancelCurrent);
        }

        if (opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Hide) return sequence;

        sequence.push(ActionSequence.Hide);
        if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === true) sequence.push(ActionSequence.Unload); //unload on hide is a setting that could change over the course of hide, so we always queue those events when hiding.
    ...
    var getUnloadSequence = function (opSession)
    {
        ...
        if (opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Load || opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Show || opSession.entry.link.paneAction === EVUI.Modules.NewPanes.PaneAction.Hide) //cancel if anything is happening already
        {
            sequence.push(ActionSequence.CancelCurrent);
        }

        if (EVUI.Modules.Core.Utils.hasFlag(opSession.entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) === true)
        {
    ...
    var getPosition = function (entry, showSettings)
    {
        ...
        if (mode !== EVUI.Modules.NewPanes.PanePositionMode.DocumentFlow && EVUI.Modules.Core.Utils.hasFlag(entry.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Visible) === false) //not visible, we can't measure it right now and therefore can't place it
        {
    ...
    @param {EVUI.Modules.NewPanes.PaneShowSettings} showSettings The settings that were used to position the Pane.
    @param {EVUI.Modules.NewPanes.PanePosition} position The position that was calculated using the show settings.*/
    var generatePaneCSS = function (entry, showSettings, position)
    {
        var positionSelector = getSelector(entry, EVUI.Modules.NewPanes.Constants.CSS_Position);
        var classesToApply = position.classNames.reverse(); //we reverse them so that they appear in the right order on the element.

        if (position.mode === EVUI.Modules.NewPanes.PanePositionMode.AbsolutePosition ||
            position.mode === EVUI.Modules.NewPanes.PanePositionMode.Anchored ||
            position.mode === EVUI.Modules.NewPanes.PanePositionMode.RelativePosition ||
            position.mode === EVUI.Modules.NewPanes.PanePositionMode.Centered ||
            position.mode === EVUI.Modules.NewPanes.PanePositionMode.None)
        {
            var rules = {};
        ...
        else if (position.mode === EVUI.Modules.NewPanes.PanePositionMode.Fullscreen)
        {
            var rules = {};
            rules.display ="inline-block";
        ...
        else if (position.mode === EVUI.Modules.NewPanes.PanePositionMode.PositionClass)
        {
            var rules = null;
    ...
    @param {EVUI.Modules.NewPanes.PaneShowSettings} showSettings The current show settings used to calculate the position.
    @param {EVUI.Modules.NewPanes.PanePosition} position The position that was calculated based on the showSettings.
    ...
    var getDimensionRules = function (entry, showSettings, position)
    {
        ...
        if (position.classNames.indexOf(EVUI.Modules.NewPanes.Constants.CSS_ClippedX) !== -1) setDims.setWidth = true;
        if (position.classNames.indexOf(EVUI.Modules.NewPanes.Constants.CSS_ClippedY) !== -1) setDims.setHeight = true;
        ...
        if (position.mode === EVUI.Modules.NewPanes.PanePositionMode.Anchored)
        {
            if (showSettings.anchors.alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) setDims.setWidth = true;
            if (showSettings.anchors.alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) setDims.setHeight = true;
    ...
    {
        var allBaseClasses =
            [EVUI.Modules.NewPanes.Constants.CSS_Position,
            EVUI.Modules.NewPanes.Constants.CSS_ScrollX,
            EVUI.Modules.NewPanes.Constants.CSS_ScrollY,
            EVUI.Modules.NewPanes.Constants.CSS_ClippedX,
            EVUI.Modules.NewPanes.Constants.CSS_ClippedY,
            EVUI.Modules.NewPanes.Constants.CSS_Flipped,
            EVUI.Modules.NewPanes.Constants.CSS_Transition_Show,
            EVUI.Modules.NewPanes.Constants.CSS_Transition_Hide,
            EVUI.Modules.NewPanes.Constants.CSS_Transition_Adjust,
            EVUI.Modules.NewPanes.Constants.CSS_Resized,
            EVUI.Modules.NewPanes.Constants.CSS_Moved];
    ...
    @param {EVUI.Modules.NewPanes.PaneShowSettings} showSettings The settings used to display the Pane.
    @param {EVUI.Modules.NewPanes.PanePosition} position The calculated position of the Pane using the showSettings.
    ...
    {
        if (typeof callback !== "function") callback = function () { };
        if (position.mode === EVUI.Modules.NewPanes.PanePositionMode.DocumentFlow) //if the pane is in the document flow, just position it
        {
        ...
        if (adjusting === true)
        {
            ...
            selector = EVUI.Modules.NewPanes.Constants.CSS_Transition_Adjust;
        }
        else
        {
            if (showSettings.showTransition != null) transition = showSettings.showTransition;
            selector = EVUI.Modules.NewPanes.Constants.CSS_Transition_Show;
        }
    ...
    var insertIntoDocumentFlow = function (entry, showSettings, position)
    {
        ...
        if (showSettings.documentFlow.mode === EVUI.Modules.NewPanes.PaneDocumentFlowMode.Current) return;

        if (showSettings.documentFlow.mode === EVUI.Modules.NewPanes.PaneDocumentFlowMode.After)
        {
        ...
        else if (showSettings.documentFlow.mode === EVUI.Modules.NewPanes.PaneDocumentFlowMode.Append)
        {
        ...
        else if (showSettings.documentFlow.mode === EVUI.Modules.NewPanes.PaneDocumentFlowMode.Before)
        {
        ...
        else if (showSettings.documentFlow.mode === EVUI.Modules.NewPanes.PaneDocumentFlowMode.Prepend)
        {
            if (ele.parentNode !== relativeElement.elements[0])
            {
                ele.remove();
    ...
    var calculatePosition = function (entry, showSettings, mode)
    {
        ...
        if (mode === EVUI.Modules.NewPanes.PanePositionMode.AbsolutePosition)
        {
            position = getAbsolutePosition(entry, ele, showSettings.absolutePosition);
        }
        else if (mode === EVUI.Modules.NewPanes.PanePositionMode.Anchored)
        {
            position = getAnchoredPosition(entry, ele, showSettings.anchors);
        }
        else if (mode === EVUI.Modules.NewPanes.PanePositionMode.RelativePosition)
        {
            position = getRelativePosition(entry, ele, showSettings.relativePosition);
        }
        else if (mode === EVUI.Modules.NewPanes.PanePositionMode.Fullscreen)
        {
            position = getFullscreenPosition();
        }
        else if (mode === EVUI.Modules.NewPanes.PanePositionMode.PositionClass)
        {
            position = getAddClassPosition(showSettings, ele);
        }
        else if (mode === EVUI.Modules.NewPanes.PanePositionMode.Centered)
        {
            position = getCenteredPosition(ele);
        }
        else if (mode === EVUI.Modules.NewPanes.PanePositionMode.DocumentFlow)
        {
            return position;
        }
    ...
    @param {EVUI.Modules.NewPanes.PaneAbsolutePosition} absolutePosition The absolute position of the Pane.
    @returns {EVUI.Modules.NewPanes.PanePosition} */
    var getAbsolutePosition = function (entry, elementHelper, absolutePosition)
    {
        var offset = elementHelper.offset();
        var position = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.AbsolutePosition);
    ...
    @param {EVUI.Modules.NewPanes.PaneAnchors} anchorSettings The instructions on how to anchor the pane to another set of elements.
    @returns {EVUI.Modules.NewPanes.PanePosition} */
    var getAnchoredPosition = function (entry, elementHelper, anchorSettings)
    {
        var position = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.Anchored);
        ...
        switch (flags)
        {
            ...
            case 3: //upper and bottom bounds, stretch to fit between top and bottom, then try to apply the x alignment evenly between both top and bottom axes
                ...
                if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Left) //align with whatever is further left
                {
                    position.left = Math.min(leftYAxisBounds.left, rightYAxisBounds.left);
                    position.right = position.left + width;
                }
                else if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Right) //align with whatever is the most right
                {
                    position.right = Math.max(leftYAxisBounds.right, rightYAxisBounds.right);
                    position.left = position.right - width;
                }
                else if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Center) //get the total span between the furthest left and most right edges and get the center between them.
                {
                ...
                else if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.None)
                {
            ...
            case 5: //left and upper bounds, align to the bottom of the top and right of the left, and optionally stretch on either axis if configured to do so
                ...
                position.top = upperBounds.bottom;
                position.bottom = (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? leftBounds.bottom : position.top + height; //if we're stretching, stretch to the bottom of the left edge. Otherwise use the normal hieght.
                position.left = leftBounds.right;
                position.right = (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? upperBounds.right : position.right + width; //if we're stretching, stretch to the right of the top edge. Otherwise use the width
                break;
            ...
            case 6: //left and lower bounds, align to the top of the bottom and right of the left, and optionally stretch on either axis if configured to do so
                ...
                position.top = (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? leftBounds.top : lowerBounds.top - height;
                ...
                position.left = leftBounds.right;
                position.right = (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? lowerBounds.right : position.right + width; //if we're stretching, stretch to the right of the top edge. Otherwise use the width
                break;
            ...
            case 7: //left, lower, and upper bounds. Align to the right of the left and stretch between the top and bottom.
                ...
                position.left = leftBounds.right;
                position.bottom = lowerBounds.top;
                position.right = (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? Math.max(upperBounds.right, lowerBounds.right) : position.left + width; //if we're stretching, stretch to the right most edge of the top or bottom
                break;
            ...
            case 9: //right and upper bounds, align to the left of the right and bottom of the top
                ...
                position.right = rightBounds.left;
                position.left = (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? upperBounds.left : position.right - width;
                position.top = upperBounds.bottom;
                position.bottom = (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? rightBounds.bottom : position.top + height;
                break;

            case 10: //right and lower bounds, align to the left of the right and top of the bottom

                position.right = rightBounds.left;
                position.left = (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? lowerBounds.left : rightBounds.left - width;
                position.top = lowerBounds.top - height;
                position.bottom = (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? position.top - height : rightBounds.bottom;
                break;
            ...
            case 11: //right, lower, and upper bounds. Stretch between upper and lower bounds and align to the right side
                ...
                position.right = rightBounds.left;
                position.bottom = lowerBounds.top;
                position.left = (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? Math.min(upperBounds.left, lowerBounds.left) : rightBounds.left - width; //if we're stretching, stretch to the right most edge of the top or bottom
                break;
            ...
            case 12: //right and left bounds. Stretch between right and left and place according to alignment between 
                ...
                if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Top) //align with whatever is highest
                {
                    position.top = Math.min(leftYAxisBounds.top, rightYAxisBounds.top);
                    position.bottom = position.top + height;
                }
                else if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Bottom) //align with whatever is lowest
                {
                    position.top = Math.min(leftYAxisBounds.bottom, rightYAxisBounds.bottom) - height;
                    position.bottom = position.top - height;
                }
                else if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Center) //get the total span between the furthest top and bottom edges and get the center between them.
                {
            ...
            case 13: //right, left, and upper bounds. Stretch between right and left, and align along the bottom of the top
                ...
                position.top = upperBounds.bottom;
                position.bottom = (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? Math.max(leftBounds.bottom, rightBounds.bottom) : position.top + height;
                position.left = leftBounds.right;
                position.right = rightBounds.left;
                break;
            ...
            case 14: //right, left, and lower bounds. Stretch between right and left, and align along the top of the bottom
                ...
                position.top = (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Elastic) ? Math.min(leftBounds.top, rightBounds.top) : lowerBounds.top - height;
                position.bottom = lowerBounds.top;
                position.left = leftBounds.right;
                position.right = rightBounds.left;
                break;
    ...
    {
        if (typeof alignment !== "string") return (axis === "x") ? EVUI.Modules.NewPanes.AnchorAlignment.Left : EVUI.Modules.NewPanes.AnchorAlignment.Top;
        alignment = alignment.toLowerCase();

        switch (alignment)
        {
            case EVUI.Modules.NewPanes.AnchorAlignment.Bottom:
            case EVUI.Modules.NewPanes.AnchorAlignment.Top:
                ...
                break;
            case EVUI.Modules.NewPanes.AnchorAlignment.Left:
            case EVUI.Modules.NewPanes.AnchorAlignment.Right:
            ...
            case EVUI.Modules.NewPanes.AnchorAlignment.Center:
            case EVUI.Modules.NewPanes.AnchorAlignment.Elastic:
            case EVUI.Modules.NewPanes.AnchorAlignment.None:
            ...
            default: //we got a bad value, return the default for the specified axis
                return (axis === "x") ? EVUI.Modules.NewPanes.AnchorAlignment.Left : EVUI.Modules.NewPanes.AnchorAlignment.Top;
        }
    };
    ...
    var getXAlignmentPosition = function (alignmentSideBounds, currentBounds, width, alignX)
    {
        ...
        if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Left) //align to the left edge of the anchored side
        {
            bounds.left = alignmentSideBounds.left;
            bounds.right = alignmentSideBounds.left + width;
        }
        else if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Right) //align to the right edge of the anchored side
        {
            bounds.left = alignmentSideBounds.right - width;
            bounds.right = alignmentSideBounds.right;
        }
        else if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.Center) //center the pane on the anchored side
        {
            var center = alignmentSideBounds.left + ((alignmentSideBounds.right - alignmentSideBounds.left) / 2);
            bounds.left = center - (width / 2);
            bounds.right = bounds.left + width;
        }
        else if (alignX === EVUI.Modules.NewPanes.AnchorAlignment.None) //don't align with the anchored side
        {
    ...
    var getYAlignmentPosition = function (alignmentSideBounds, currentBounds, height, alignY)
    {
        ...
        if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Top) //align to the top edge of the anchored side
        {
            bounds.top = alignmentSideBounds.top;
            bounds.bottom = alignmentSideBounds.top - height;
        }
        else if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Bottom) //align to the bottom edge of the anchored side
        {
            bounds.top = alignmentSideBounds.bottom - height;
            bounds.bottom = alignmentSideBounds.bottom;
        }
        else if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.Center) //center the pane on the anchored side
        {
        ...
        else if (alignY === EVUI.Modules.NewPanes.AnchorAlignment.None) //do not align with the anchored side
        {
    ...
    @param {InternalPaneEntry} entry The Pane being positioned.
    @param {EVUI.Modules.Dom.DomHelper} elementHelper The root element of the pane.
    @param {EVUI.Modules.NewPanes.PaneRelativePosition} relativeSettings The instructions for the relative positioning.
    @returns {EVUI.Modules.NewPanes.PanePosition} */
    var getRelativePosition = function (entry, elementHelper, relativeSettings)
    {
        var relativeBounds = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.RelativePosition);
        ...
        if (xOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Right) //we are putting the left edge of the pane on the right edge of the relative reference
        {
            relativeBounds.left = positionBounds.right;
            relativeBounds.right = positionBounds.right + width;
        }
        else if (xOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Left) //we are putting the right edge of the pane on the left edge of the relative reference
        {
            relativeBounds.left = positionBounds.left - width;
            relativeBounds.right = positionBounds.left;
        }

        if (yOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom) //we are putting the top of the pane along the bottom edge of the relative reference.
        {
            relativeBounds.top = positionBounds.bottom;
            relativeBounds.bottom = positionBounds.bottom + height;
        }
        else if (yOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Top) //we are putting the bottom of the pane along the top edge of the relative reference
        {
    ...
    @param {EVUI.Modules.NewPanes.PanePosition} positionBounds The bounds of the position the pane is being oriented around.
    ...
    @param {EVUI.Modules.NewPanes.PaneRelativePosition} relativeSettings The settings for the relative posotion.
    ...
    var applyRelativePositionAlignment = function (positionBounds, relativeBounds, relativeSettings, xOrientation, yOrientation)
    {
        ...
        {
            case EVUI.Modules.NewPanes.RelativePositionAlignment.Bottom: //aligning the top of the element with the bottom of the relative element

                if (yOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Top) //only applies if we are oriented to the top, if we're oriented to the bottom, there is nothing to do
                {
            ...
            case EVUI.Modules.NewPanes.RelativePositionAlignment.YCenter: //aligning to the center of the Y axis

                if (yOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom) //move the bottom up by half the size of the relative element
                {
                    relativeBounds.top -= positionHeight / 2;
                    relativeBounds.bottom -= positionHeight / 2;
                }
                else if (yOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Top) //move the top down by half the size of the relative element
                {
                    relativeBounds.top += positionHeight / 2
                    relativeBounds.bottom += positionHeight / 2;
                }
            ...
            case EVUI.Modules.NewPanes.RelativePositionAlignment.Top: //align the bottom of the element with the top of the relative element

                if (yOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom) //only applies if we are oriented at the bottom of the relative element, otherwise there is nothing to do
                {
                    relativeBounds.top -= positionHeight;
                    relativeBounds.bottom -= positionHeight;
                }
            ...
            case EVUI.Modules.NewPanes.RelativePositionAlignment.Left: //aligning the element on the left side of the relative element

                if (xOrientation === EVUI.Modules.NewPanes.RelativePositionAlignment.Right) //only applies if we are oriented to the right, otherwise we are already on the left
                {
            ...
            case EVUI.Modules.NewPanes.RelativePositionAlignment.XCenter: //aligning to the center of the x axis of the relative element

                if (xOrientation === EVUI.Modules.NewPanes.RelativePositionAlignment.Right) //move left by half the width
                {
                    relativeBounds.left -= positionWidth / 2;
                    relativeBounds.right -= positionWidth / 2;
                }
                else if (xOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Left) //move right by half the with
                {
                    relativeBounds.left += positionWidth / 2;
                    relativeBounds.right += positionWidth / 2;
                }
                break;
            case EVUI.Modules.NewPanes.RelativePositionAlignment.Right: //aligning to the right edge of the relative element

                if (xOrientation === EVUI.Modules.NewPanes.RelativePositionOrientation.Left) //only applies if we are oriented to the left of the relative element, otherwise we're already on the right
                {
                    relativeBounds.left += positionWidth;
                    relativeBounds.right += positionWidth;
                }
    ...
    var getRelativeOrientationAxis = function (orientation)
    {
        ...
        switch (orientation)
        {
            case EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom:
            case EVUI.Modules.NewPanes.RelativePositionOrientation.Top:
                return "y";
            case EVUI.Modules.NewPanes.RelativePositionOrientation.Left:
            case EVUI.Modules.NewPanes.RelativePositionOrientation.Right:
                return "x";
        }
    ...
    var getOrientationAlignment = function (relativeSettings)
    {
        ...
        if (xOrientation == null) xOrientation = EVUI.Modules.NewPanes.RelativePositionOrientation.Right;

        var yOrientation = (getRelativeOrientationAxis(orientations[1]) === "y") ? orientations[1] : orientations[0];
        if (yOrientation == null) yOrientation = EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom;
    ...
    {
        var position = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.Fullscreen);
    ...
    @param {EVUI.Modules.NewPanes.PaneShowSettings} showSettings The settings for showing the pane.
    ...
    var getAddClassPosition = function (showSettings, ele)
    {
        ...
        var positionClasses = addedClasses.concat([EVUI.Modules.NewPanes.Constants.CSS_Position, entry.link.paneCSSName]);

        var position = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.PositionClass);
    ...
    var getCenteredPosition = function (ele)
    {
        ...
        var position = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.Centered);
    ...
    {
        if (showSettings == null) return EVUI.Modules.NewPanes.PanePositionMode.None;
        ...
        if (showSettings.positionClass != null) //we have a value for position classes
        {
            ...
            {
                return EVUI.Modules.NewPanes.PanePositionMode.PositionClass; //its a string that will be applied as a class name
            }
            else if (EVUI.Modules.Core.Utils.isArray(showSettings.positionClass) === true)
            {
                ...
                {
                    return EVUI.Modules.NewPanes.PanePositionMode.PositionClass; //it is an array of class names
                }
            }
        }
        ...
        if (showSettings.absolutePosition != null) //we have a value for absolute position
        {
            ...
            {
                return EVUI.Modules.NewPanes.PanePositionMode.AbsolutePosition;
            }
        }
        ...
        if (showSettings.relativePosition != null) //we have a value for relative position
        {
            ...
            {
                return EVUI.Modules.NewPanes.PanePositionMode.RelativePosition; //the relative element must be part of the DOM to be a valid target to orient around (so we can get its position)
            }
            else if (showSettings.relativePosition.x !== 0 || showSettings.relativePosition.y !== 0)
            {
                return EVUI.Modules.NewPanes.PanePositionMode.RelativePosition; //if one of the coordinates is non zero value it can be a target for orientation
            }
        }
        ...
        if (showSettings.anchors != null) //we have a value for anchors
        {
            ...
            {
                return EVUI.Modules.NewPanes.PanePositionMode.Anchored; //at least one anchor must be non-null and connected to the DOM to be a valid target (so we can get its position)
            }
        }
        ...
        if (showSettings.documentFlow != null) //we have a value for document flow
        {
            ...
            {
                return EVUI.Modules.NewPanes.PanePositionMode.DocumentFlow;
            }
        }

        //full screen mode was set
        if (showSettings.fullscreen === true) return EVUI.Modules.NewPanes.PanePositionMode.Fullscreen;

        //center mode was set
        if (showSettings.center === true) return EVUI.Modules.NewPanes.PanePositionMode.Centered;

        //northing worked, not going to do anything with the position other than stick it in the top-left of the view port.
        return EVUI.Modules.NewPanes.PanePositionMode.None;
    };
    ...
    var applyClipSettings = function (entry, position, clipSettings, showSettings, previousClipSettings)
    {
        ...
        {
            clipSettings = new EVUI.Modules.NewPanes.PaneClipSettings();
        }
        ...
        {
            clipSettings.fallbackClipSettings = new EVUI.Modules.NewPanes.PaneClipSettings();
            clipSettings.fallbackClipSettings.clipBounds = null;
            clipSettings.fallbackClipSettings.mode = EVUI.Modules.NewPanes.PaneClipMode.Clip;
        ...
        if (clipSettings.mode === EVUI.Modules.NewPanes.PaneClipMode.Clip)
        {
    ...
    @param {EVUI.Modules.NewPanes.PanePosition|EVUI.Modules.Dom.ElementBounds} position The position to check for being out of bounds.
    @param {EVUI.Modules.NewPanes.PanePosition|EVUI.Modules.Dom.ElementBounds} bounds Optional. Wither the pane bounds or another arbitrary set of bounds.
    @returns {Boolean} */
    ...
    @param {EVUI.Modules.NewPanes.PaneClipSettings} clipSettings The instructions for how to clip the Pane.
    @returns {EVUI.Modules.NewPanes.PanePosition}*/
    var clipToBounds = function (entry, position, bounds, clipSettings)
    {
        ...
        if (clipped === true) //we need to clip the height and width of the pane.
        {
            ...
            {
                position.classNames.push(EVUI.Modules.NewPanes.Constants.CSS_ClippedX);
                ...
                if (clipSettings.scrollXWhenClipped === true) //if the "scroll when clipped" option is set, make a selector class for adding the overflow scrollbar to the pane
                {
                    ...
                    {
                        position.classNames.push(EVUI.Modules.NewPanes.Constants.CSS_ScrollX);

                        var scrollXSelector = getSelector(entry, EVUI.Modules.NewPanes.Constants.CSS_ClippedX);
            ...
            {
                position.classNames.push(EVUI.Modules.NewPanes.Constants.CSS_ClippedY);
                ...
                {
                    if (newHeight < originalHeight) position.classNames.push(EVUI.Modules.NewPanes.Constants.CSS_ScrollY);

                    var scrollYSelector = getSelector(entry, EVUI.Modules.NewPanes.Constants.CSS_ClippedY);
    ...
    var shiftToBounds = function (entry, position, bounds, clipSettings, showSettings, previousClipSettings)
    {
        ...
        var shiftedY = false;
        var delta = 0;
        var relativePositioned = position.mode === EVUI.Modules.NewPanes.PanePositionMode.RelativePosition;
        ...
        positionCopy = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.NewPanes.PanePosition(position.mode), positionCopy);
        ...
        if (position.mode === EVUI.Modules.NewPanes.PanePositionMode.Fullscreen && (shiftedX === true || shiftedY === true))
        {
    ...
    var flipRelativePosition = function (entry, position, bounds, clipSettings, showSettings, previousClipSettings, flags)
    {
        ...
        if (isOutOfBounds(position, bounds, "right") === true) //overflowing to the right
        {
            ...
            {
                if (alignX === EVUI.Modules.NewPanes.RelativePositionOrientation.Left) //left side is aligned to the right side of the relative point, flip over X axis.
                {
                    flippedAlignX = EVUI.Modules.NewPanes.RelativePositionOrientation.Right;
                    flippedX = true;
                }
                else if (alignX === EVUI.Modules.NewPanes.RelativePositionOrientation.Right) //the right side is aligned to the left of the relative point, and that right side is outside the bounds. Clipping will result in a 0 width Pane, so this is an error.
                {
                    flippedAlignX = EVUI.Modules.NewPanes.RelativePositionOrientation.Left;
                    flippedX = true;
                }
        ...
        if (isOutOfBounds(position, bounds, "left") === true) //overflowing to the left
        {
            ...
            {
                if (alignX === EVUI.Modules.NewPanes.RelativePositionOrientation.Right) //flip over x axis
                {
                    flippedAlignX = EVUI.Modules.NewPanes.RelativePositionOrientation.Left;
                    flippedX = true;
                }
                else if (alignX === EVUI.Modules.NewPanes.RelativePositionOrientation.Left) //
                {
                    flippedAlignX = EVUI.Modules.NewPanes.RelativePositionOrientation.Right;
                    flippedX = true;
                }
        ...
        if (isOutOfBounds(position, bounds, "top") === true)
        {
            ...
            {
                if (alignY === EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom)
                {
                    flippedAlignY = EVUI.Modules.NewPanes.RelativePositionOrientation.Top;
                    flippedY = true;
                }
                else if (alignY === EVUI.Modules.NewPanes.RelativePositionOrientation.Top)
                {
                    flippedAlignY = EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom;
                    flippedY = true;
                }
        ...
        if (isOutOfBounds(position, bounds, "bottom") === true)
        {
            ...
            {
                if (alignY === EVUI.Modules.NewPanes.RelativePositionOrientation.Top)
                {
                    flippedAlignY = EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom;
                    flippedY = true;
                }
                else if (alignY === EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom)
                {
                    flippedAlignY = EVUI.Modules.NewPanes.RelativePositionOrientation.Top;
                    flippedY = true;
                }
        ...
        {
            position.classNames.push(EVUI.Modules.NewPanes.Constants.CSS_Flipped);
            return position;
        }
    ...
    {
        if (typeof clipMode !== "string") return EVUI.Modules.NewPanes.PaneClipMode.Shift;
        clipMode = clipMode.toLowerCase();

        switch (clipMode)
        {
            case EVUI.Modules.NewPanes.PaneClipMode.Clip:
            case EVUI.Modules.NewPanes.PaneClipMode.Overflow:
            case EVUI.Modules.NewPanes.PaneClipMode.Shift:
                return clipMode;
            default:
                return EVUI.Modules.NewPanes.PaneClipMode.Shift;
        }
    };
    ...
    @param {EVUI.Modules.NewPanes.PaneResizeMoveArgs} resizeArgs The arguments about how it will be resized.
    ...
    var resizePane = function (entry, resizeArgs, helper, resized, moved, dragHandles, clipBounds)
    {
        if (moved === true)
        {
            ...
            var movedSelector = getSelector(entry, EVUI.Modules.NewPanes.Constants.CSS_Moved);
            ...
            helper.addClass(EVUI.Modules.NewPanes.Constants.CSS_Moved);
            entry.link.lastResizeArgs = resizeArgs;
        }

        if (resized === true)
        {
            var resizedSelector = getSelector(entry, EVUI.Modules.NewPanes.Constants.CSS_Resized);
            ...
            {
                var position = new EVUI.Modules.NewPanes.PanePosition();
            ...
            helper.addClass(EVUI.Modules.NewPanes.Constants.CSS_Resized);
        ...
        applyTransition(entry, resizeArgs.resizeTransition, EVUI.Modules.NewPanes.Constants.CSS_Transition_Adjust, helper)
    ...
    {
        var currentPosition = new EVUI.Modules.NewPanes.PanePosition(EVUI.Modules.NewPanes.PanePositionMode.AbsolutePosition);
    ...
    var hookUpExplicitCloseZones = function (entry)
    {
        ...
        var attributeName = getAttributeName(EVUI.Modules.NewPanes.Constants.Attribute_Close);
        ...
        for (var x = 0; x < numZones; x++)
        {
            var handler = new EVUI.Modules.NewPanes.PaneEventBinding(attributeName, "click", closeZones.elements[x], function (event)
            {
                ...
                context.triggerType = EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.Explicit;
    ...
    var hookUpAutoCloseMode = function (entry)
    {
        ...
        if (entry.link.pane.autoCloseSettings.closeMode === EVUI.Modules.NewPanes.PaneCloseMode.Click) //a click anywhere will close the Pane
        {
            ...
            {
                var context = new EVUI.Modules.NewPanes.PaneAutoTriggerContext();
                context.triggerType = EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.Click;
                context.browserEvent = event;
                context.eventBinding = handler;
                context.target = entry.link.wrapper == null ? entry.link.pane : entry.link.wrapper;
        ...
        else if (entry.link.pane.autoCloseSettings.closeMode === EVUI.Modules.NewPanes.PaneCloseMode.ExteriorClick) //only a click outside the Pane's root element will close the Pane
        {
            ...
            {
                var context = new EVUI.Modules.NewPanes.PaneAutoTriggerContext();
                context.triggerType = EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.ExteriorClick;
                context.browserEvent = event;
                context.eventBinding = handler;
                context.target = entry.link.wrapper == null ? entry.link.pane : entry.link.wrapper;
    ...
    var hookUpKeydownClose = function (entry)
    {
        ...
        var handler = new EVUI.Modules.NewPanes.PaneEventBinding("autoCloseKey", "keydown", document, function (event)
        {
            ...
            var context = new EVUI.Modules.NewPanes.PaneAutoTriggerContext();
            context.triggerType = EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.KeyDown;
            context.browserEvent = event;
            context.eventBinding = handler;
            context.target = entry.link.wrapper == null ? entry.link.pane : entry.link.wrapper;
    ...
    var hookUpDrag = function (entry)
    {
        ...
        var attributeName = getAttributeName(EVUI.Modules.NewPanes.Constants.Attribute_Drag);
        ...
        {
            var curEle = eles[x];
            var handler = new EVUI.Modules.NewPanes.PaneEventBinding(attributeName, "mousedown", curEle, function (downEvent)
            {
                _settings.stylesheetManager.ensureSheet(EVUI.Modules.Styles.Constants.DefaultStyleSheetName, { lock: true });
                ...
                var dragHandler = function (dragEvent)
                {
                    ...
                    var resizeArgs = new EVUI.Modules.NewPanes.PaneResizeMoveArgs();
    ...
    var hookUpSetHighestZOrder = function (paneEntry)
    {
        var handler = new EVUI.Modules.NewPanes.PaneEventBinding(null, "mousedown", paneEntry.link.pane.element, function (eventArgs)
        {
            if (paneEntry.link.pane.showSettings != null && paneEntry.link.pane.showSettings.alwaysOnTop !== true) return;

            var curZIndex = paneEntry.link.pane.getCurrentZIndex();
            if (curZIndex >= EVUI.Modules.NewPanes.Constants.GlobalZIndex) return;

            EVUI.Modules.NewPanes.Constants.GlobalZIndex++;

            curZIndex = EVUI.Modules.NewPanes.Constants.GlobalZIndex;
            var selector = "." + paneEntry.link.paneCSSName + "." + EVUI.Modules.Dialogs.Constants.CSS_Position;
    ...
    var hookUpResize = function (entry)
    {
        ...
        var handler = new EVUI.Modules.NewPanes.PaneEventBinding("dragResize", "mousedown", entry.link.pane.element, function (downEvent)
        {
    ...
    @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback A callback to call once the operation completes or the function returns without adding a transition.*/
    ...
    var getLoadMode = function (loadSettings)
    {
        ...
        if (loadSettings.httpLoadArgs != null) return EVUI.Modules.NewPanes.PaneLoadMode.HTTP;

        if (loadSettings.placeholderLoadArgs != null) return EVUI.Modules.NewPanes.PaneLoadMode.Placeholder;

        return EVUI.Modules.NewPanes.PaneLoadMode.None;
    };
    ...
    var unloadRootElement = function (entry)
    {
        ...
        else if (loadMode === EVUI.Modules.NewPanes.PaneLoadMode.HTTP)
        {
            entry.link.pane.element.remove();
            entry.link.pane.element = null;
        }
    ...
    var hideRootElement = function (entry, showSettings, hideTransition, callback)
    {
        ...
        applyTransition(entry, hideTransition, EVUI.Modules.NewPanes.Constants.CSS_Transition_Hide, ele, function ()
        {
            clearEvents(entry);
            ...
            var mode = getPositionMode(showSettings);
            if (mode === EVUI.Modules.NewPanes.PanePositionMode.DocumentFlow)
            {
                ele.hide();
            }
            else
    ...
    @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback The callback to call once the operation*/
    ...
    @param {EVUI.Modules.NewPanes.PaneManagerSettings} paneSettings The settings to attach all the global variables to. */
...
@class*/
EVUI.Modules.NewPanes.Pane = function (id, options)
{
    ...
    Object.defineProperty(this, "element",
    {
        ...
        set: function (value)
        {
            ...
            if (_options.canSetElement(setObject) === true)
            {
    ...
    @type {String}*/
    this.template = EVUI.Modules.NewPanes.PaneTemplateType.None;

    /**Object. Settings for how the Pane's element will be loaded or assigned.
    @type {EVUI.Modules.NewPanes.PaneLoadSettings}*/
    this.loadSettings = new EVUI.Modules.NewPanes.PaneLoadSettings();

    /**Object. Settings for how the Pane's element will be positioned and displayed.
    @type {EVUI.Modules.NewPanes.PaneShowSettings}*/
    this.showSettings = new EVUI.Modules.NewPanes.PaneShowSettings();

    /**Object. Rules for controlling what will cause the Pane to recalculate its position.
    @type {EVUI.Modules.NewPanes.PaneRecalcSettings}*/
    this.reclacSettings = new EVUI.Modules.NewPanes.PaneRecalcSettings();
    ...
    Object.defineProperty(this, "isVisible", {
        get: function () { return EVUI.Modules.Core.Utils.hasFlag(options.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Visible) },
        configurable: false,
        enumerable: true
    });
    ...
    Object.defineProperty(this, "isLoaded", {
        get: function () { return EVUI.Modules.Core.Utils.hasFlag(options.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Loaded) },
        configurable: false,
        enumerable: true
    });
    ...
    Object.defineProperty(this, "isInitialized", {
        get: function () { return EVUI.Modules.Core.Utils.hasFlag(options.link.paneStateFlags, EVUI.Modules.NewPanes.PaneStateFlags.Initialized) },
        configurable: false,
        enumerable: true
    });
    ...
    //@returns {EVUI.Modules.NewPanes.PaneEventBinding[]}*/
    ...
    //    var binding = new EVUI.Modules.NewPanes.PaneEventBinding(null, event, ele, handler);
    //    binding.attach();
    ...
    /**Shows the pane according to the PaneShowArgs argument.
    @param {EVUI.Modules.NewPanes.PaneShowArgs} showArgs Arguments for showing the Pane.
    @param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback A callback function that fires once the Pane has been displayed.*/
    this.show = function (showArgs, callback)
    {
        return options.link.manager.showPane(_id, showArgs, callback);
    };
    ...
    {
        return options.link.manager.showPaneAsync(_id, showArgs);
    };

    this.hide = function (hideArgs, callback)
    {
        return options.link.manager.hidePane(_id, hideArgs, callback);
    };

    this.hideAsync = function (hideArgs)
    {
        return options.link.manager.hidePaneAsync(_id, hideArgs);
    };

    this.load = function (loadArgs, callback)
    {
        return options.link.manager.loadPane(_id, loadArgs, callback);
    };

    this.loadAsync = function (loadArgs)
    {
        return options.link.manager.loadPaneAsync(_id, loadArgs);
    }

    this.unload = function (unloadArgs, callback)
    {
        return options.link.manager.unloadPane(_id, unloadArgs, callback);
    };

    this.unloadAsync = function (unloadArgs)
    {
        return options.link.manager.unloadPaneAsync(_id, unloadArgs);
    };
...
@enum*/
EVUI.Modules.NewPanes.PaneCloseMode =
{
...
Object.freeze(EVUI.Modules.NewPanes.PaneCloseMode);
...
@class*/
EVUI.Modules.NewPanes.PaneLoadSettings = function ()
{
    var _element = null;
...
@enum*/
EVUI.Modules.NewPanes.PaneLoadMode =
{
...
Object.freeze(EVUI.Modules.NewPanes.PaneLoadMode);
...
@class*/
EVUI.Modules.NewPanes.PaneShowSettings = function ()
{
    ...
    @type {EVUI.Modules.NewPanes.PaneAbsolutePosition}*/
    ...
    @type {EVUI.Modules.NewPanes.PaneRelativePosition}*/
    ...
    @type {EVUI.Modules.NewPanes.PaneBackdropSettings}*/
...
@class*/
EVUI.Modules.NewPanes.PaneDocumentFlow = function ()
{
    ...
    @type {String}*/
    this.mode = EVUI.Modules.NewPanes.PaneDocumentFlowMode.Append;
};
...
@enum*/
EVUI.Modules.NewPanes.PaneClipMode =
{
...
Object.freeze(EVUI.Modules.NewPanes.PaneDocumentFlowMode);

/**Object for containing the absolute location of the Pane relative to the current view port.
@class*/
EVUI.Modules.NewPanes.PaneAbsolutePosition = function (options)
{
    var _options = options;
    var _top = 0;
    var _left = 0;
...
@class*/
EVUI.Modules.NewPanes.PaneRelativePosition = function ()
{
    var _relativeElement = null;
    ...
    @type {String}*/
    this.orientation = EVUI.Modules.NewPanes.RelativePositionOrientation.Bottom + " " + EVUI.Modules.NewPanes.RelativePositionOrientation.Right;

    /**String. The alignment of the Pane relative to the side of the point or element.
    @type {String}*/
    this.alignment = EVUI.Modules.NewPanes.RelativePositionAlignment.None;
...
@class*/
EVUI.Modules.NewPanes.PaneRecalcSettings = function ()
{
    ...
    @type {String}*/
    this.paneResizeResponse = EVUI.Modules.NewPanes.PaneResizeResponseMode.None;
...
@ennum*/
EVUI.Modules.NewPanes.PaneResizeResponseMode =
{
...
Object.freeze(EVUI.Modules.NewPanes.RelativePositionOrientation);

/**Controls the alignment of the Pane along the X or Y axis when it is positioned relative to an Element.
@enum*/
EVUI.Modules.NewPanes.RelativePositionAlignment =
{
...
Object.freeze(EVUI.Modules.NewPanes.RelativePositionAlignment);

/**Object for containing the elements that a Pane can have its sides be anchored to.
@class*/
EVUI.Modules.NewPanes.PaneAnchors = function ()
{
    var _top = null;
    var _left = null;
    var _bottom = null;
    ...
    @type {String}*/
    this.alignX = EVUI.Modules.NewPanes.AnchorAlignment.Elastic;
    ...
    @type {String}*/
    this.alignY = EVUI.Modules.NewPanes.AnchorAlignment.Elastic;
};
...
@enum*/
EVUI.Modules.NewPanes.AnchorAlignment =
{
...
Object.freeze(EVUI.Modules.NewPanes.AnchorAlignment);

/**A read-only look at a Pane's current state.
@class*/
EVUI.Modules.NewPanes.PaneEntry = function (paneLink)
{
    ...
    /**String. The current operation the pane is performing (loading, unloading, hiding, showing, etc).
    @type {String}*/
    this.currentPaneAction = EVUI.Modules.NewPanes.PaneAction.None;
...
@class*/
EVUI.Modules.NewPanes.PaneEventBinding = function (attr, event, element, handler)
{
    var _attribute = attr;
    var _event = event;
...
@class*/
EVUI.Modules.NewPanes.PaneAutoTriggerContext = function ()
{
    ...
    @type {String}*/
    this.triggerType = EVUI.Modules.NewPanes.PaneAutoCloseTriggerType.None;
...
@enum*/
EVUI.Modules.NewPanes.PaneAutoCloseTriggerType =
{
...
Object.freeze(EVUI.Modules.NewPanes.PaneAutoCloseTriggerType);
...
@class*/
EVUI.Modules.NewPanes.PaneTransition = function ()
{
...
@class*/
EVUI.Modules.NewPanes.PaneResizeMoveSettings = function ()
{
...
@class*/
EVUI.Modules.NewPanes.PaneBackdropSettings = function ()
{
...
@enum */
EVUI.Modules.NewPanes.PaneTemplateType =
{
    /**Default. No template.*/
    None: "none",
...
Object.freeze(EVUI.Modules.NewPanes.PaneTemplateType);

/**Event arguments for all of the Pane events.
@class */
EVUI.Modules.NewPanes.PaneEventArgs = function (entry, currentArgs)
{
    ...
    @type {EVUI.Modules.NewPanes.PaneShowArgs|EVUI.Modules.NewPanes.PaneHideArgs|EVUI.Modules.NewPanes.PaneLoadArgs|EVUI.Modules.NewPanes.PaneUnloadArgs}*/
...
@enum*/
EVUI.Modules.NewPanes.PaneStateFlags =
{
...
Object.freeze(EVUI.Modules.NewPanes.PaneStateFlags);

/**Enum for describing the current action of the Pane.
@enum*/
EVUI.Modules.NewPanes.PaneAction =
{
    /**Pane is at rest.*/
    None: "none",
...
Object.freeze(EVUI.Modules.NewPanes.PaneAction);

/**Describes the calculated position of a Pane in absolute coordinates. 
@class*/
EVUI.Modules.NewPanes.PanePosition = function (mode)
{
    var _mode = mode;
    ...
    @type {String}*/
    this.mode = EVUI.Modules.NewPanes.PanePositionMode.None;
...
@enum*/
EVUI.Modules.NewPanes.PanePositionMode =
{
...
Object.freeze(EVUI.Modules.NewPanes.PanePositionMode);
...
@type {EVUI.Modules.NewPanes.PaneManager}*/
EVUI.Modules.NewPanes.Manager = null;
(function ()
{
    var ctor = EVUI.Modules.NewPanes.PaneManager;
    var manager = null;

    Object.defineProperty(EVUI.Modules.NewPanes, "Manager", {
        get: function ()
        {
...
@class*/
EVUI.Modules.NewPanes.PaneShowArgs = function ()
{
    /**String. The type of arguments contained within the object.
    @type {String}*/
    this.type = null;
    Object.defineProperty(this, "type", {
        get: function () { return EVUI.Modules.NewPanes.PaneArgumentType.Show; },
        configurable: false,
        enumerable: false
    });
...
@class*/
EVUI.Modules.NewPanes.PaneLoadArgs = function ()
{
    /**String. The type of arguments contained within the object.
    @type {String}*/
    this.type = null;
...
@class*/
EVUI.Modules.NewPanes.PaneHideArgs = function ()
{
    /**String. The type of arguments contained within the object.
    @type {String}*/
    this.type = null;
    Object.defineProperty(this, "type", {
        get: function () { return EVUI.Modules.NewPanes.PaneArgumentType.Hide; },
        configurable: false,
        enumerable: false
    });
...
@class*/
EVUI.Modules.NewPanes.PaneUnloadArgs = function ()
{
    /**String. The type of arguments contained within the object.
    @type {String}*/
    this.type = null;
    Object.defineProperty(this, "type", {
        get: function () { return EVUI.Modules.NewPanes.PaneArgumentType.Unload; },
        configurable: false,
        enumerable: false
    });
...
@class*/
EVUI.Modules.NewPanes.PaneResizeMoveArgs = function ()
{
    /**String. The type of arguments contained within the object.
    @type {String}*/
    this.type = null;
    Object.defineProperty(this, "type", {
        get: function () { return EVUI.Modules.NewPanes.PaneArgumentType.MoveResize; },
        configurable: false,
        enumerable: false
    });
...
@class*/
EVUI.Modules.NewPanes.PaneArgsPackage = function (context)
{
...
@enum*/
EVUI.Modules.NewPanes.PaneArgumentType =
{
...
Object.freeze(EVUI.Modules.NewPanes.PaneArgumentType);

EVUI.Modules.NewPanes.PaneManagerServices = function ()
{
    /**Object. The HttpManager used to make web requests from the PaneManager.
    @type {EVUI.Modules.Http.HttpManager}*/
    this.httpManager = null;
...
Object.defineProperty($evui, "panes", {
    get: function () { return EVUI.Modules.NewPanes.Manager },
    enumerable: true
});

Object.freeze(EVUI.Modules.NewPanes);

/**Constructor reference for the PaneManager.*/
EVUI.Constructors.Panes = EVUI.Modules.NewPanes.PaneManager;

 /**Gets a Pane object based on its ID or a selector function.
@param {EVUI.Modules.NewPanes.Constants.Fn_PaneSelector|String} paneIDOrSelector A selector function to select a PaneEntry object (or multiple PaneEntry objects) or the ID of the Pane to get the PaneEntry for.
@param {Boolean} getAllMatches If a selector function is provided, all the PaneEntries that satisfy the selector are included. Otherwise a single PaneEntry object is returned. False by default.
@returns {EVUI.Modules.NewPanes.Pane|EVUI.Modules.NewPanes.Pane[]} */
$evui.getPane = function (paneIDOrSelector, getAllMatches)
{
    return $evui.panes.getPane(paneIDOrSelector, getAllMatches);
};

/**Adds a Pane to the PaneManager.
@param {EVUI.Modules.NewPanes.Pane} yoloPane A YOLO object representing a Pane object. This object is copied onto a real Pane object is then discarded.
@returns {EVUI.Modules.NewPanes.Pane}*/
...
@param {EVUI.Modules.NewPanes.Pane|String} paneOrID Either a YOLO Pane object to extend into the existing Pane, the real Pane reference, or the string ID of the Pane to hide.
@param {EVUI.Modules.NewPanes.PaneHideArgs|EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} paneHideArgs Optional. The arguments for hiding a Pane or the callback. If omitted or passed as a function, the Pane's existing hide/unload settings are used instead.
@param {EVUI.Modules.NewPanes.Constants.Fn_PaneOperationCallback} callback Optoinal. A callback that is called once the operation completes.*/
