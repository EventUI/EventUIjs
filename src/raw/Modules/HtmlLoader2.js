...
/*#BEGINWRAP(EVUI.Modules.HtmlLoader2|HtmlLoader)#*/
/*#REPLACE(EVUI.Modules.HtmlLoader22|HtmlLoader)#*/

/**Module for containing a EventStream-driven Html partial/placeholder loader that loads foreign Html via Http.
@module*/
EVUI.Modules.HtmlLoader2 = {};

/*#MODULEDEF(HtmlLoader|"1.0";|"HtmlLoader")#*/
/*#VERSIONCHECK(EVUI.Modules.HtmlLoader22|HtmlLoader)#*/

EVUI.Modules.HtmlLoader2.Dependencies =
{
...
(function ()
{
    ...
    Object.defineProperty(EVUI.Modules.HtmlLoader2.Dependencies, "checked",
        {
...
Object.freeze(EVUI.Modules.HtmlLoader2.Dependencies);

EVUI.Modules.HtmlLoader2.Constants = {};

EVUI.Modules.HtmlLoader2.Constants.Job_GetHtml = "evui.htmlLoader.getHtml";
EVUI.Modules.HtmlLoader2.Constants.Job_InjectHtml = "evui.htmlLoader.injectHtml";
EVUI.Modules.HtmlLoader2.Constants.Job_LoadChildren = "evui.htmlLoader.loadChildren";

EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID = "evui-loader-placeholder-id";
EVUI.Modules.HtmlLoader2.Constants.Attr_ResourceUrl = "evui-loader-placeholder-src";
EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState = "evui-loader-content-load-state";

EVUI.Modules.HtmlLoader2.Constants.Event_OnBeforePlaceholderLoad = "evui.htmlLoader.onBeforeLoad";
EVUI.Modules.HtmlLoader2.Constants.Event_OnGetPlaceholderHtml = "evui.htmlLoader.onGetPlaceholderHtml";
EVUI.Modules.HtmlLoader2.Constants.Event_OnPlaceholderInject = "evui.htmlLoader.onInject";
EVUI.Modules.HtmlLoader2.Constants.Event_OnBeforeLoadPlaceholderChildren = "evui.htmlLoader.onBeforeLoadChildren";
EVUI.Modules.HtmlLoader2.Constants.Event_OnPlaceholderLoaded = "evui.htmlLoader.onPlaceholderLoaded";
EVUI.Modules.HtmlLoader2.Constants.Event_OnAllPlaceholdersLoaded = "evui.hmlLoader.onAllPlaceholdersLoaded"
...
EVUI.Modules.HtmlLoader2.Constants.Fn_GetHtml_Callback = function (html) { };

/**Callback function that is called when a collection of Html partials have all been loaded.
@param {EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]} loadRequests An array of EVUI.Modules.HtmlLoader2Controller.HtmlPartialLoadRequest representing all the requests that have completed (successfully or not).*/
EVUI.Modules.HtmlLoader2.Constants.Fn_GetPartials_Callback = function (loadRequests) { };

/**Callback function that is called when a html placeholder has been completely loaded and injected into the DOM.
 @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholder} placeholderResult The details of the completed placeholder load.*/
EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback = function (placeholderResult) { }

/**Callback function that is called when a html placeholder has been completely loaded and injected into the DOM.
 @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholder[]} placeholderResult The details of all the completed placeholder loads.*/
EVUI.Modules.HtmlLoader2.Constants.Fn_GetAllPlaceholders_Callback = function (placeholderResult) { }

Object.freeze(EVUI.Modules.HtmlLoader2.Constants)
...
/**Controller for loading HTML, either as a bunch of small partial pieces of HTML or for loading larger placeholders which can also contain placeholders.
 @class*/
EVUI.Modules.HtmlLoader2.HtmlLoader2Controller = function (services)
{
    if (EVUI.Modules.Core == null) throw Error("Dependency missing: EVUI.Modules.Core is required.");
    EVUI.Modules.Core.Utils.requireAll(EVUI.Modules.HtmlLoader2.Dependencies);

    //self reference for closures
    var _self = this;

    /**The services used by the HtmlLoaderController.
    @type {EVUI.Modules.HtmlLoader2.HtmlLoader2ControllerServices}*/
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlRequestArgs} htmlRequestArgsOrUrl The Url of the html or the arguments for getting the Html.
    @param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetHtml_Callback} getHtmlCallback  A function to call once the server has completed the request, takes the string version of whatever was returned as a parameter. */
    this.loadHtml = function (htmlRequestArgsOrUrl, getHtmlCallback)
    {
        ...
        if (typeof htmlRequestArgsOrUrl === "string")
        {
            ...
            htmlRequestArgsOrUrl = new EVUI.Modules.HtmlLoader2.HtmlRequestArgs();
            htmlRequestArgsOrUrl.url = url;
        }

        var htmlArgs = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.HtmlLoader2.HtmlRequestArgs(), htmlRequestArgsOrUrl);
    ...
    @param {String|EVUI.Modules.HtmlLoader2.HtmlRequestArgs} htmlRequestArgsOrUrl  The Url of the html or the arguments for getting the Html.
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs|EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]} partialLoadArgsOrPartialRequests Either an array of HtmlPartialLoadRequests or a HtmlPartialLoadArgs object.
    @param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPartials_Callback} loadedCallback A callback that is fired once all the Html partials have been loaded.*/
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs|EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]} partialLoadArgsOrPartialRequests Either an array of HtmlPartialLoadRequests or a HtmlPartialLoadArgs object.
    @returns {Promise<EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]>}.*/
    ...
    var loadHtmlPartials = function (partialLoadArgsOrPartialRequests, allLoadedCallback)
    {
        ...
        if (EVUI.Modules.Core.Utils.isArray(partialLoadArgsOrPartialRequests) === true) //we were handed an array of what should be EVUI.Modules.HtmlPartialLoadRequests, make an arguments object to hold them
        {
            ...
            partialLoadArgsOrPartialRequests = new EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs();
        ...
        var partialsArgs = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs(), partialLoadArgsOrPartialRequests);
        partialArgs.htmlPartialLoadRequests = partialsArgs.htmlPartialLoadRequests.map(function (req) { return EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest(), req); });
    ...
    var translateResponseToText = function (response, callback)
    {
        ...
        {
            return EVUI.Modules.Core.Utils.debugReturn("EVUI.Modules.HtmlLoader2Controller.Manager", "translateResponseToText", ex.stack, null);
        }
    };

    /**Loads a placeholder and all of its children and injects it into the DOM.
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs|String} placeholderIDOrArgs The value of a PlaceholderID attribute or a graph of HtmlPlaceholderLoadArgs.
    @param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback} callback A callback function that is executed once the placeholder load operation is complete.*/
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs|String} placeholderIDOrArgs The value of a EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute or a graph of HtmlPlaceholderLoadArgs.
    @returns {Promise<EVUI.Modules.HtmlLoader2.HtmlPlaceholder>}*/
    ...
    /**Loads all placeholders currently in the document (elements with the EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute present with a non-empty string value) in parallel, but excludes those that are flagged as being loaded upon on demand.
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs} placehoderLoadArgs The arguments for loading all the placeholders currently in the document.
    @param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback} callback A callback function that is called once all the placeholders in the document have been loaded and injected into the DOM.*/
    ...
    /**Loads all placeholders currently in the document (elements with the EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute present with a non-empty string value) in parallel, but excludes those that are flagged as being loaded upon on demand.
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs} placehoderLoadArgs The arguments for loading all the placeholders currently in the document.
    @returns {Promise<EVUI.Modules.HtmlLoader2.HtmlPlaceholder>} callback A callback function that is called once all the placeholders in the document have been loaded and injected into the DOM.*/
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs|String} placeholderLoadArgs The value of a EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute or a graph of HtmlPlaceholderLoadArgs.
    @param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback} callback A callback function that is executed once the placeholder load operation is complete.*/
    var loadAllPlaceholders = function (placeholderLoadArgs, callback)
    {
        if (typeof placeholderLoadArgs === "string")
        {
            ...
            placeholderLoadArgs = new EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs();
            placeholderLoadArgs.placeholderID = placeholderID;
        }
        else
        {
            //make a safe copy of the args to work with
            placeholderLoadArgs = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs(), placeholderLoadArgs);
        ...
        {
            elements = new EVUI.Modules.Dom.DomHelper("[" + EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID + "=\"" + placeholderLoadArgs.placeholderID + "\"]", null).elements;
        }
        else
        {
        ...
        es.addJob(function (args)
        {
            ...
            for (var x = 0; x < numEles; x++)
            {
                ...
                var placeholderID = attrs.getValue(EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID);
    ...
    var loadPlaceholder = function (placeholderIDOrArgs, callback)
    {
        if (typeof placeholderIDOrArgs === "string")
        {
            ...
            placeholderIDOrArgs = new EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs();
    ...
    {
        var byPlaceholderID = new EVUI.Modules.Dom.DomHelper("[" + EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID + "=\"" + placeholderID + "\"]", contextElement);
        if (byPlaceholderID.first() != null) return byPlaceholderID.first();

        var byUrl = new EVUI.Modules.Dom.DomHelper("[" + EVUI.Modules.HtmlLoader2.Constants.Attr_ResourceUrl + "=\"" + placeholderID + "\"]", contextElement);
        return byUrl.first();
    };
    ...
    var getChildLoadElements = function (context)
    {
        ...
        var eh = new EVUI.Modules.Dom.DomHelper("[" + EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID + "]", context);
        ...
        var byUrl = new EVUI.Modules.Dom.DomHelper("[" + EVUI.Modules.HtmlLoader2.Constants.Attr_ResourceUrl + "]", context);
        var numByUrl = byUrl.elements.length;
        for (var x = 0; x < numByUrl; x++)
        {
            var curEle = byUrl.elements[x];
            if (EVUI.Modules.Core.Utils.stringIsNullOrWhitespace(curEle.getAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID)) === true)
            {
                curEle.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID, curEle.getAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_ResourceUrl))
                eles.push(curEle);
            }
        }
    ...
    var getLoadableElements = function (context, forceReload, ignoreOnDemand)
    {
        ...
        for (var x = 0; x < numChildren; x++)
        {
            ...
            var loadState = attrs.getValue(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState);
            if (loadState != null)
            {
                loadState = loadState.toLowerCase();
                if (loadState === EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loaded && forceReload !== true) continue;
                if (loadState === EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.OnDemand && ignoreOnDemand !== true) continue;
                if (loadState === EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loading || loadState === EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Pending) continue;
            }

            curChild.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState, EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Pending);
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs} sourcePlaceholderLoadArgs The event args to clone and use for the load session.
    @param {PlaceholderLoadSession} parentSession The session that spawned this session.
    @param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback} callback A callback function to call once the placeholder has been fully loaded.
    ...
    var makePlaceholderLoadSession = function (placeholderID, sourcePlaceholderLoadArgs, parentSession, callback)
    {
        ...
        if (EVUI.Modules.Core.Utils.stringIsNullOrWhitespace(placeholderID) === true)
        {
            ...
            {
                ele = placeholderID;
                placeholderID = ele.getAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID);
            }
        ...
        if (ele == null)
        {
            if (sourcePlaceholderLoadArgs != null && sourcePlaceholderLoadArgs.httpArgs != null && EVUI.Modules.Core.Utils.stringIsNullOrWhitespace(sourcePlaceholderLoadArgs.httpArgs.url) === false)
            {
                ...
                loadDiv.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_PlaceholderID, placeholderID);
                loadDiv.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_ResourceUrl, sourcePlaceholderLoadArgs.httpArgs.url);
        ...
        {
            ele.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState, EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.CircularReference);
            return callback(null);
        }

        //clone the arguments for this session.
        var newArgs = EVUI.Modules.Core.Utils.shallowExtend(new EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs(), sourcePlaceholderLoadArgs);
        ...
        session.placeholder = new EVUI.Modules.HtmlLoader2.HtmlPlaceholder(session);
        ...
        session.loadState = EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Pending;
        return session;
    };
    ...
    var setUpEventStream = function (session, callback)
    {
        ...
        {
            var htmlArgs = new EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadEventArgs();
        ...
        {
            if (step.key === EVUI.Modules.HtmlLoader2.Constants.Event_OnBeforeLoadPlaceholderChildren)
            {
    ...
    var addOnBeforeLoadEvents = function (session)
    {
        session.eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Event_OnBeforePlaceholderLoad,
    ...
    var addOnBeforeLoadChildrenEvents = function (session)
    {
        session.eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Event_OnBeforeLoadPlaceholderChildren,
    ...
    var addOnInjectEvents = function (session)
    {
        session.eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Event_OnPlaceholderInject,
    ...
    var addOnPlaceholderLoadedEvents = function (session)
    {
        session.eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Event_OnPlaceholderLoaded,
    ...
    var addOnAllPlaceholderLoadedEvents = function (session)
    {
        if (session.parentSession == null)
        {
            session.eventStream.addStep(
                {
                    key: EVUI.Modules.HtmlLoader2.Constants.Event_OnAllPlaceholdersLoaded,
    ...
    var buildEventStream = function (session, callback)
    {
        ...
        eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Job_GetHtml,
                name: "GetHtml",
                ...
                handler: function (jobArgs)
                {
                    ...
                    var loadState = placeholderAttrs.getValue(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState);
                    ...
                    if (loadState != null && loadState.toLowerCase() === EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loaded && session.placeholderArgs.forceReload === false)
                    {
                    ...
                    var url = placeholderAttrs.getValue(EVUI.Modules.HtmlLoader2.Constants.Attr_ResourceUrl);

                    var htmlArgs = new EVUI.Modules.HtmlLoader2.HtmlRequestArgs();
                    htmlArgs.url = url;
        ...
        eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Job_LoadChildren,
                name: "LoadChildren",
                type: EVUI.Modules.EventStream.EventStreamStepType.Job,
                handler: function (jobArgs)
                {
                    ...
                    for (var x = 0; x < numChildSessions; x++)
                    {
                        ...
                        curChild.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState, EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loading);
                        session.loadState = EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loading;
        ...
        eventStream.addStep(
            {
                key: EVUI.Modules.HtmlLoader2.Constants.Job_InjectHtml,
                name: "InjectHtml",
                type: EVUI.Modules.EventStream.EventStreamStepType.Job,
                handler: function (jobArgs)
                {
                    if (session.loadedFragment != null) //we have content, blow away old content and replace it with new content
                    {
                        ...
                        eh.attr(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState, EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loaded); //set the load state so this placeholder isn't loaded again
                        session.loadState = EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Loaded;
                    }
                    else //no content, flag it as failed
                    {
                        session.placeholderElement.setAttribute(EVUI.Modules.HtmlLoader2.Constants.Attr_ContentLoadState, EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Failed);
                        session.loadState = EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState.Failed;
                    }
    ...
    var ensureServices = function ()
    {
        ...
        {
            _services = new EVUI.Modules.HtmlLoader2.HtmlLoader2ControllerServices();
        }
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadEventArgs} args: An instance of EVUI.Modules.HtmlLoader2Controller.HtmlPlaceholderLoadEventArgs describing the current load operation.*/
    ...
    @param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadEventArgs} args: An instance of EVUI.Modules.HtmlLoader2Controller.HtmlPlaceholderLoadEventArgss describing the current load operation.*/
    ...
    var PlaceholderLoadSession = function ()
    {
        ...
        @type {EVUI.Modules.HtmlLoader2.HtmlPlaceholder}*/
        ...
        @type {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs} */
...
@class*/
EVUI.Modules.HtmlLoader2.HtmlRequestArgs = function ()
{
...
@class*/
EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest = function (url, key)
{
    /**String. The Url to get the Html from.
    @type {String}*/
...
@class*/
EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs = function ()
{
    var _partialLoadRequests = [];

    /**Array. An array of EVUI.Modules.HtmlLoader2Controller.HtmlPartialLoadRequest representing all the Html partials to get.
    @type {EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]}*/
...
@class*/
EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadEventArgs = function ()
{
...
@class */
EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs = function ()
{
    ...
    /**Event that executes before the request to get HTML from the server has been sent and gives the opportunity to stop the operation before it begins.
    les.HtmlLoader2Controller.HtmlPlaceholderLoadEventArgs} args: An instance of EVUI.Modules.HtmlLoader2Controller.HtmlPlaceholderLoadEventArgs describing the current load operation.*/
    this.onBeforePlaceholderLoad = function (args)
    {
...
/**Object representing the return value of a HtmlPlaceholder load operation. 
 @class*/
EVUI.Modules.HtmlLoader2.HtmlPlaceholder = function (session)
{
    ...
    /**Object. The instance of EVUI.Modules.HtmlLoader2Controller.HtmlPlaceholderLoadArgs used to load this placeholder.
    @type {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs}*/
    this.loadArgs = null;
    ...
    /**Array. An array of EVUI.Modules.HtmlLoader2Controller.HtmlPlaceholderLoadResult representing the child placeholders loaded under this one.
    @type {EVUI.Modules.HtmlLoader2.HtmlPlaceholder[]}*/
    this.children = null;
...
@enum*/
EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState =
{
...
Object.freeze(EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadState);

/**Object to inject the standard dependencies used by the HtmlLoaderController into it via its constructor.
@class*/
EVUI.Modules.HtmlLoader2.HtmlLoader2ControllerServices = function ()
{
...
/**Global instance of a EVUI.Modules.HtmlLoader2Controller.HtmlLoader2Controller.
 @type {EVUI.Modules.HtmlLoader2.HtmlLoader2Controller}*/
EVUI.Modules.HtmlLoader2.Manager = null;
(function ()
{
    var loader = null;

    Object.defineProperty(EVUI.Modules.HtmlLoader2, "Manager",
    {
        get: function ()
        {
            if (loader == null) loader = new EVUI.Modules.HtmlLoader2.HtmlLoader2Controller();
            return loader;
        },
        configurable: false,
        enumerable: true
...
@type {EVUI.Modules.HtmlLoader2.HtmlLoader2Controller}*/
$evui.htmlLoader2 = null;
Object.defineProperty($evui, "htmlLoader2",
{
    get: function ()
    {
        return EVUI.Modules.HtmlLoader2.Manager;
    },
    enumerable: true
});
...
/**Makes a simple GET request to get Html. The request defaults to a GET with a response type of "text". If a different response type is used, the result is translated back into a string.
@param {EVUI.Modules.HtmlLoader2.HtmlRequestArgs} htmlRequestArgsOrUrl The Url of the html or the arguments for getting the Html.
@param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetHtml_Callback} getHmlCallback  A function to call once the server has completed the request, takes the string version of whatever was returned as a parameter. */
$evui.loadHtml2 = function (htmlRequestArgsOrUrl, getHtmlCallback)
{
    return $evui.htmlLoader2.loadHtml(htmlRequestArgsOrUrl, getHtmlCallback);
};

/**Awaitable. Makes a simple GET request to get html. The request defaults to a GET with a response type of "text". If a different response type is used, the result is translated back into a string.
@param {EVUI.Modules.HtmlLoader2.HtmlRequestArgs} htmlRequestArgs  The Url of the html or the arguments for getting the Html.
@returns {Promise<String>}*/
$evui.loadHtmlAsync2 = function (htmlRequestArgsOrUrl)
{
    return $evui.htmlLoader2.loadHtmlAsync(htmlRequestArgsOrUrl);
};

/**Loads an array of PartialLoadRequeusts either as a standalone array or as part of a HtmlPartalLoadArgs object.
@param {EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs|EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]} partialLoadArgsOrPartialRequests Either an array of HtmlPartialLoadRequests or a HtmlPartialLoadArgs object.
@param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPartials_Callback} loadedCallback A callback that is fired once all the Html partials have been loaded.*/
$evui.loadHtmlPartials2 = function (partialLoadArgsOrPartialRequests, loadedCallback)
{
    return $evui.htmlLoader2.loadAllPlacehoders(partialLoadArgsOrPartialRequests, loadedCallback);
};

/**Awaitable. Loads an array of PartialLoadRequeusts either as a standalone array or as part of a HtmlPartalLoadArgs object.
@param {EVUI.Modules.HtmlLoader2.HtmlPartialLoadArgs|EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]} partialLoadArgsOrPartialRequests Either an array of HtmlPartialLoadRequests or a HtmlPartialLoadArgs object.
@returns {Promise<EVUI.Modules.HtmlLoader2.HtmlPartialLoadRequest[]>}.*/
$evui.loadHtmlPartialsAsync2 = function (partialLoadArgsOrPartialRequests)
{
    return $evui.htmlLoader2.loadHtmlPartialsAsync(partialLoadArgsOrPartialRequests);
};

/**Loads a placeholder and all of its children and injects it into the DOM.
@param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs|String} placeholderIDOrArgs The value of a PlaceholderID attribute or a graph of HtmlPlaceholderLoadArgs.
@param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback} callback A callback function that is executed once the placeholder load operation is complete.*/
$evui.loadPlaceholder2 = function (placeholderIDOrArgs, callback)
{
    return $evui.htmlLoader2.loadPlaceholder(placeholderIDOrArgs, callback);
};

/**Awaitable. Loads a placeholder and all of its children and injects them into the DOM.
@param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs|String} placeholderIDOrArgs The value of a EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute or a graph of HtmlPlaceholderLoadArgs.
@param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetPlaceholder_Callback} callback A callback function that is executed once the placeholder load operation is complete.
@returns {Promise<EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadResult>}*/
$evui.loadPlaceholderAsync2 = function (placeholderIDOrArgs)
{
    return $evui.htmlLoader2.loadPlaceholderAsync(placeholderIDOrArgs);
};

/**Loads all placeholders currently in the document (elements with the EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute present with a non-empty string value) in parallel, but excludes those that are flagged as being loaded upon on demand.
@param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs} placehoderLoadArgs The arguments for loading all the placeholders currently in the document.
@param {EVUI.Modules.HtmlLoader2.Constants.Fn_GetAllPlaceholders_Callback} callback A callback function that is called once all the placeholders in the document have been loaded and injected into the DOM.*/
$evui.loadAllPlaceholders2 = function (placehoderLoadArgs, callback)
{
    return $evui.htmlLoader2.loadAllPlaceholders(placehoderLoadArgs, callback);
};

/**Awaitable. Loads all placeholders currently in the document (elements with the EVUI.Modules.HtmlLoader2Controller.Constants.Attr_PlaceholderID attribute present with a non-empty string value) in parallel, but excludes those that are flagged as being loaded upon on demand.
@param {EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadArgs} placehoderLoadArgs The arguments for loading all the placeholders currently in the document.
@returns {Promise<EVUI.Modules.HtmlLoader2.HtmlPlaceholderLoadResult[]>} callback A callback function that is called once all the placeholders in the document have been loaded and injected into the DOM.*/
$evui.loadAllPlaceholdersAsync2 = function (placehoderLoadArgs)
{
    return $evui.htmlLoader2.loadAllPlaceholdersAsync(placehoderLoadArgs);
};

Object.freeze(EVUI.Modules.HtmlLoader2);
